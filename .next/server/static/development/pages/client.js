...
})(["display:flex;.daynum{display:flex;color:lightslategray;margin:2px 5.5px;width:25px;height:20px;background:transparent;}"]);
...
})(["position:relative;display:grid;grid-row:1/2;box-sizing:border-box;padding-left:6px;width:100%;overflow-y:scroll;background:white;.message{margin:0px 10px;padding:20px 0;border-bottom:1.5px solid rgba(220,220,220,0.4);}.message-username{font-size:11px;color:#3e5869;opacity:0.9;margin-bottom:6px;}.message-text{background:rgba(220,220,220,0.8);font-family:'Montserrat',sans-serif;color:black;display:block;font-size:12px;padding:8px 12px;border-radius:8px;max-width:50%;min-width:300px;}"]);
var DUMMY_DATA = [{
  senderId: 'perborgen',
...
})(["display:grid;grid-template-columns:270px minmax(420px,1fr) 300px;grid-template-rows:1fr 250px;height:calc(100% - 140px);width:100%;position:absolute;padding-left:10px;padding-right:10px;top:125px;grid-column-gap:8px;bottom:0;z-index:-1;"]);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_timekeeper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-timekeeper */ "react-timekeeper");
...
var StyledPicka = styled_components__WEBPACK_IMPORTED_MODULE_2___default.a.div.withConfig({
...
/***/ "react-timekeeper":
/*!***********************************!*\
  !*** external "react-timekeeper" ***!
  \***********************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = require("react-timekeeper");
