...
})(["background-color:#fff;border-radius:25px;display:block;position:absolute;width:500px;height:500px;padding:55px 25px 15px 25px;z-index:999;box-shadow:1px 1px 5px 3px rgba(0,0,0,0.3);"]);
...
})(["padding:3px 10px;margin:4px auto;border-width:2px;border-style:solid;position:relative;display:flex;justify-content:center;background:transparent;color:white;background:rgba(20,110,240,1);color:white;border-color:white;min-width:50px;text-align:center;cursor:pointer;border-radius:25px;list-style:none;transition:0.2s;&:hover{box-shadow:1px 1px 4px 3px rgba(0,0,0,0.1);}"]);
...
})(["background:transparent;color:red;font-weight:800;display:block;position:relative;border:3px solid red;margin:10px 0px;border-radius:50%;font-size:2rem;float:right;padding:0.4rem 0.8rem;font-size:1.8rem;transition:all 0.5s;outline:none;cursor:pointer;box-shadow:1px 1px 4px 2px rgba(0,0,0,0.2);&[disabled]{opacity:0.5;}&:hover{background:rgba(230,10,40,0.5);color:white;border-color:white;transform:scale(1.1);}&:active{box-shadow:none;}"]);
...
//# sourceMappingURL=schedule.js.ac635a5a7d4538da23c6.hot-update.js.map