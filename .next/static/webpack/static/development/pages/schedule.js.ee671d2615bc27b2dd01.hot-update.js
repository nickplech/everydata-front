...
})(["background-color:#fff;border-radius:5px;display:grid;grid-row:3;position:relative;align-items:center;margin:0 auto;height:70%;background:rgba(20,100,220,1);color:white;width:120px;font-size:22px;z-index:900;"]);
...
})(["background-color:#fff;border-radius:5px;display:grid;grid-row:3;margin:0 auto;position:relative;align-items:center;width:120px;height:70%;background:rgba(20,100,220,1);color:white;font-size:22px;z-index:900;"]);
...
//# sourceMappingURL=schedule.js.ee671d2615bc27b2dd01.hot-update.js.map