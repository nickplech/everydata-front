...
})(["display:inline-block;background:transparent;border:2px solid white;margin-left:20%;padding:8px 12px;margin-top:15px;color:white;border-radius:5px;font-size:18px;cursor:pointer;&:hover{border-color:rgba(100,100,220,1);transition:0.2s;transform:scale(1.1);color:white;}"]);
...
})(["display:inline-block;background:rgba(100,100,220,1);border:2px solid rgba(100,100,220,1);margin-left:25px;padding:8px 12px;width:200px;margin-top:15px;color:white;border-radius:5px;font-size:18px;cursor:pointer;&:hover{border-color:white;color:white;}"]);
...
//# sourceMappingURL=index.js.2a5c87dd3f7854681112.hot-update.js.map