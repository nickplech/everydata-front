...
})(["display:block;font-size:11px;bottom:20px;left:600px;position:absolute;z-index:1000px;"]);
...
})(["grid-column:2;grid-row:2;position:relative;z-index:6;margin:0 10px;width:80%;padding:10px;height:100%;max-height:140px;border-radius:10px;font-size:1.5rem;resize:none;border:none;background:rgba(250,250,250,1);box-shadow:0 0 4px 3px rgba(0,0,0,0.05);&:focus{outline:none;}"]);
...
//# sourceMappingURL=client.js.8850f70078358fdfb325.hot-update.js.map