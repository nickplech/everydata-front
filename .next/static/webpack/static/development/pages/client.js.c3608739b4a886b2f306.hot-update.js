...
})(["padding:10px 10px;display:flex;justify-content:center;align-items:center;max-width:600px;border-radius:25px;margin:10px 0px;min-height:50px;box-shadow:0 0 4px 2px rgba(0,0,0,0.1);cursor:pointer;transition:0.4s;&:hover{background:rgba(10,110,220,0.3);}&:active{box-shadow:none;}h5{font-size:16px;margin:5px;font-weight:400;font-family:'Montserrat',sans-serif;}.content{overflow:hidden;font-size:18px;border-radius:20px;background:rgba(240,240,240,0.7);color:black;min-width:330px;width:100%;margin-bottom:0px;}.content-wrapper{padding:20px 10px;}"]);
...
//# sourceMappingURL=client.js.c3608739b4a886b2f306.hot-update.js.map