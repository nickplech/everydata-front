...
/* harmony import */ var react_transition_group__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! react-transition-group */ "./node_modules/react-transition-group/index.js");
...
/* harmony import */ var _Clients__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./Clients */ "./components/Clients.js");
...
var AnimationStyles = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].div.withConfig({
  displayName: "ReviewMessage__AnimationStyles",
  componentId: "sc-1kkiazb-0"
})(["position:relative;.count{display:block;position:relative;transition:all 0.4s;}.count-enter{transform:translateY(100%);}.count-enter-active{transform:translateY(0);}.count-exit{transform:translateY(0);}.count-exit-active{transform:translateY(100%);}"]);
...
var Submitted = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].div.withConfig({
  displayName: "ReviewMessage__Submitted",
  componentId: "sc-1kkiazb-3"
})(["display:block;position:absolute;min-width:300px;width:30%;text-align:center;padding:10px;background:rgba(20,180,110,0.9);color:white;border-radius:5px;bottom:15px;box-shadow:0 16px 24px 2px rgba(0,0,0,0.1),0 6px 10px 5px rgba(0,0,0,0.1),0 8px 10px -5px rgba(0,0,0,0.2);right:20px;z-index:999;"]);
...
function (_Component) {
  ...
  _createClass(ReviewMessage, [{
    ...
    value: function render() {
      ...
      var date = this.state.date ? Object(date_fns__WEBPACK_IMPORTED_MODULE_6__["format"])(this.state.date, 'ddd, MMM Do') : '<selectdate>';
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_User__WEBPACK_IMPORTED_MODULE_8__["default"], {
        ...
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_4__["Query"], {
          ...
          return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_4__["Mutation"], {
            ...
            refetchQueries: _Clients__WEBPACK_IMPORTED_MODULE_10__["ALL_CLIENTS_QUERY"],
            __source: {
              fileName: _jsxFileName,
              lineNumber: 201
            },
            ...
            return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Back, {
              ...
              __self: this
            }, "Appointment Reminder Failed to Send. Please Try Again Shortly"), !error && !loading && called && react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(AnimationStyles, {
              __source: {
                fileName: _jsxFileName,
                lineNumber: 227
              },
              __self: this
            }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_transition_group__WEBPACK_IMPORTED_MODULE_9__["TransitionGroup"], {
              __source: {
                fileName: _jsxFileName,
                lineNumber: 228
              },
              __self: this
            }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_transition_group__WEBPACK_IMPORTED_MODULE_9__["CSSTransition"], {
              unmountOnExit: true,
              className: "count",
              classNames: "count",
              key: textReminder.id,
              ...
              __self: this
            }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Submitted, {
              __source: {
                fileName: _jsxFileName,
                lineNumber: 236
              },
...
//# sourceMappingURL=client.js.9f9563ab9496de493a33.hot-update.js.map