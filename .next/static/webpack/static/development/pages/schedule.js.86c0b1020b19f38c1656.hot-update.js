...
})(["position:relative;display:grid;grid-row:1/3;grid-column:2/3;width:100%;height:100%;background-color:white;box-shadow:0 0 5px 3px rgba(0,0,0,0.05);border:5px solid white;border-radius:25px;z-index:-1;.parent{display:flex;flex-flow:column;position:absolute;right:0px;margin-right:3px;margin-left:3px;align-items:flex-end;border-radius:25px 25px 0 0;text-align:center;padding-right:20px;height:61px;width:100%;background:rgba(100,100,240,1);}.date{display:flex;text-transform:uppercase;margin:0;color:rgba(100,100,240,1);font-size:14px;}.sideDate{display:flex;color:white;margin:0;font-family:'Montserrat',sans-serif;font-size:26px;line-height:26px;padding-top:10px;}"]);
...
//# sourceMappingURL=schedule.js.86c0b1020b19f38c1656.hot-update.js.map