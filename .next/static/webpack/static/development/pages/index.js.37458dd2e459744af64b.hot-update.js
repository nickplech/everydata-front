...
})(["display:flex;padding:10px 0px;align-items:center;justify-content:center;margin:0 auto;margin-top:70px;margin-bottom:70px;background:white;color:gray;border:none;border-radius:40px;width:250px;text-transform:uppercase;font-size:16px;box-shadow:2px 3px 2px 2px rgba(0,0,0,0.2);outline:none;"]);
...
//# sourceMappingURL=index.js.37458dd2e459744af64b.hot-update.js.map