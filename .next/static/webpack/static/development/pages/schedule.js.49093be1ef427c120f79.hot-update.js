...
})(["display:grid;grid-template-columns:1fr 1fr 1fr;grid-auto-rows:20px;grid-gap:1px;width:100%;border-bottom:2px solid grey;border-right:2px solid lightblue;margin-top:90px;height:75vh;overflow-y:scroll;overscroll-behavior:contain;.timeCell{display:flex;padding-left:5px;align-items:center;border-bottom:none;border-top:1px solid white;border-left:5px solid lightblue;background:rgba(100,100,240,0.2);color:grey;&:hover{background:blue;opacity:0.2;}}.lower{display:flex;padding-left:5px;align-items:center;border-bottom:none;border-top:1px solid white;border-left:5px solid lightblue;background:rgba(243,241,244,1);color:grey;&:hover{background:blue;opacity:0.1;}}"]);
var DUMMY_DATA = [{
  time: 8,
  am: true,
  q2: 815,
...
//# sourceMappingURL=schedule.js.49093be1ef427c120f79.hot-update.js.map