...
function (_React$Component) {
  ...
  function Timer() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onFocusChange", function (focusStatue) {// do something
    });
  ...
  _createClass(Timer, [{
    ...
    value: function render() {
      ...
      if (!defaultTime) {
        ...
        var _timeHelper$current$s = timeHelper.current().split(/:/);

        var _timeHelper$current$s2 = _slicedToArray(_timeHelper$current$s, 2);
...
//# sourceMappingURL=client.js.4dd33b7cf6ba8021ad5a.hot-update.js.map