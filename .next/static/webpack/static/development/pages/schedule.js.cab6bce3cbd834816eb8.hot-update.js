...
})(["display:grid;grid-template-columns:1fr;grid-auto-rows:25px;grid-gap:1px;width:100%;border:none;border-left:3px solid blue;margin-top:20px;height:95%;overflow-y:scroll;overscroll-behavior:contain;.timeCell{display:flex;padding-left:5px;align-items:center;color:grey;border:1px solid grey;}"]);
var DUMMY_DATA = [{
  time: 6,
  am: true
}, {
...
//# sourceMappingURL=schedule.js.cab6bce3cbd834816eb8.hot-update.js.map