...
})(["border:none;border-radius:50%;outline:none;text-align:center;color:white;display:flex;cursor:pointer;position:relative;width:30px;height:30px;margin:0px 2px -5px 2px;&:hover{transform:scale(1.1);}&:disabled{opacity:0.4;}"]);
var hourOptions = [{
  value: '1:00',
  label: '1'
}, {
...
//# sourceMappingURL=client.js.81741a68e44aa63a4453.hot-update.js.map