...
})(["grid-row:2/3;grid-column:2;width:100%;height:100%;margin:0;z-index:5;border-radius:20px;border:5px solid white;box-shadow:1px 0 4px 2px rgba(0,0,0,0.1);background-color:rgba(220,220,220,0.3);"]);
...
})(["display:grid;grid-template-columns:1fr 1fr;grid-template-rows:1fr 50px;position:relative;flex-flow:column;width:100%;height:100%;justify-content:center;"]);
var CharCount = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].span.withConfig({
  displayName: "ReviewMessage__CharCount",
  componentId: "sc-1kkiazb-2"
})(["display:block;font-size:11px;bottom:0px;left:40px;position:absolute;z-index:10px;"]);
var MessageEdit = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
  displayName: "ReviewMessage__MessageEdit",
  componentId: "sc-1kkiazb-3"
})(["background:white;display:grid;grid-column:2;position:relative;z-index:6;width:85%;height:calc(100% - 40px);border-radius:10px;align-self:center;justify-self:center;max-width:800px;"]);
...
//# sourceMappingURL=client.js.b306dbcdb9dcae93dd1a.hot-update.js.map