...
})(["display:flex;padding:20px 0px;align-items:center;justify-content:center;background:white;color:gray;border:none;border-radius:40px;width:250px;text-transform:uppercase;font-size:16px;box-shadow:2px 3px 2px 2px rgba(0,0,0,0.2);&:active{outline:none;box-shadow:1px 1px 0 0 rgba(0,0,0,0.1);}"]);
...
//# sourceMappingURL=index.js.74deb1d1868be5402a98.hot-update.js.map