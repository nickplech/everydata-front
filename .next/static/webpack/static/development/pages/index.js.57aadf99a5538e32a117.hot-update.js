...
})(["font-family:'Montserrat',sans-serif;z-index:5;margin-top:300px;.confirmation{color:rgba(100,240,100,1);}p{position:relative;margin:0;display:block;max-width:700px;z-index:5;color:white;font-size:1.4rem;padding-left:20%;}.title{position:relative;display:block;margin-bottom:0px;color:white;font-weight:600;padding-left:20%;font-size:2.7rem;}"]);
...
//# sourceMappingURL=index.js.57aadf99a5538e32a117.hot-update.js.map