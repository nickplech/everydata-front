...
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n  mutation addToCart(\n    $id: ID!\n    $confirmationStatus: String! # $textReminder: ID!\n  ) {\n    addToCart(\n      id: $id\n      confirmationStatus: $confirmationStatus # textReminder: $textReminder\n    ) {\n      id\n      quantity\n      confirmationStatus\n    }\n  }\n"]);
...
var SEND_TEXT_MUTATION = graphql_tag__WEBPACK_IMPORTED_MODULE_3___default()(_templateObject2());
...
//# sourceMappingURL=client.js.187500a56d669167b0a0.hot-update.js.map