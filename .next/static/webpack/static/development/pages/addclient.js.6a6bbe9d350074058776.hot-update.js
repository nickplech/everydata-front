...
var Inner = styled_components__WEBPACK_IMPORTED_MODULE_9__["default"].div.withConfig({
  ...
  componentId: "h45ly-0"
})(["max-width:", ";margin:0 auto;padding:2rem;.dates{font-family:montserrat,sans-serif;text-transform:uppercase;&:focus{opacity:1;}&:active{opacity:1;}}.profPic{width:120px;height:120px;background-color:lightgrey;background-position:center;background-repeat:no-repeat;border-radius:50%;margin-top:20px;border:2px solid rgba(20,110,220,0.5);box-shadow:1px 2px 5px 3px rgba(0,0,0,0.1);cursor:pointer;}"], function (props) {
...
//# sourceMappingURL=addclient.js.6a6bbe9d350074058776.hot-update.js.map