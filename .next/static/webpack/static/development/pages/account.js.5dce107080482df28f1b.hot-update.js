...
var OPEN_SLIDE_QUERY = graphql_tag__WEBPACK_IMPORTED_MODULE_2___default()(_templateObject());
var TOGGLE_SLIDE_MUTATION = graphql_tag__WEBPACK_IMPORTED_MODULE_2___default()(_templateObject2());
...
})(["background:green;border-radius:50%;display:flex;align-items:center;justify-content:center;height:30px;width:30px;padding-bottom:6px;border:1px solid green;position:absolute;z-index:20;cursor:pointer;opacity:0.6;outline:none;&:hover{transform:scale(1.1);}.child{position:absolute;justify-self:center;display:flex;color:white;font-size:3rem;padding-left:0px;}"]);
...
//# sourceMappingURL=account.js.5dce107080482df28f1b.hot-update.js.map