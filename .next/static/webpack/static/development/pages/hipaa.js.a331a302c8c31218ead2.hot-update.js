...
})(["display:flex;flex-flow:column;align-items:center;margin:0;padding:0;.plus{width:20px;height:20px;display:inline-block;text-align:center;border:2px solid white;border-radius:50%;margin-right:40px;background:white;color:purple;}#root{display:flex;flex-direction:column;width:400px;color:white;font-family:'PT Sans',Helvetica,sans-serif;}h1{margin-bottom:20px;color:Black;text-align:center;}h2{margin:0;color:white;font-size:16px;width:50%;}.title{cursor:pointer;background-image:linear-gradient( -180deg,rgba(100,100,240,1) 0%,rgba(100,160,220,1) 300px );padding:10px 20px;}.content{overflow:hidden;font-size:18px;background:rgba(100,220,240,0.4);color:white;width:50%;}.content-wrapper{padding:20px 20px;}"]);
var data = [{
...
//# sourceMappingURL=hipaa.js.a331a302c8c31218ead2.hot-update.js.map