...
function (_Component) {
  ...
  function ReviewMessage() {
    ...
    _defineProperty(_assertThisInitialized(_this), "saveToState", function (e) {
      ...
      var addVariables = val.replace('<time>', time).replace('<date>', date);
  ...
  _createClass(ReviewMessage, [{
    ...
    value: function render() {
      ...
      var date = Object(date_fns__WEBPACK_IMPORTED_MODULE_6__["format"])(this.state.date, 'ddd, MMM Do'); // const finishedMessage = this.state.text
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_4__["Mutation"], {
        ...
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Form, {
          ...
          saveDateToState: _this2.saveToState,
          __source: {
            fileName: _jsxFileName,
            lineNumber: 236
          },
...
//# sourceMappingURL=client.js.e0228a4f7caca7cc2769.hot-update.js.map