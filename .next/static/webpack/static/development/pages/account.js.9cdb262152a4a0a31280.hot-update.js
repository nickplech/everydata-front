...
})(["background:rgba(20,110,240,1);border-radius:50%;display:flex;align-items:center;justify-content:center;height:30px;width:30px;box-shadow:1px 1px 4px 2px rgba(0,0,0,0.3);border:none;position:relative;z-index:20;cursor:pointer;opacity:0.6;outline:none;-webkit-touch-callout:none;-webkit-user-select:none;-khtml-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;&:hover{transform:scale(1.1);}.child{position:absolute;justify-self:center;display:flex;font-family:'Montserrat',sans-serif;color:white;font-size:3.5rem;padding-left:0px;}"]);
...
//# sourceMappingURL=account.js.9cdb262152a4a0a31280.hot-update.js.map