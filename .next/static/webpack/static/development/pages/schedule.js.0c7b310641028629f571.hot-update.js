...
})(["display:grid;grid-template-columns:1fr;width:100%;border:none;height:90%;overflow-y:scroll;overscroll-behavior:contain;.parent{display:flex;justify-content:center;}.date{display:flex;padding-top:7px;color:rgba(100,160,220,1);}"]);
...
var SingleDay = function SingleDay(props) {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(DayView, {
    ...
    __self: this
  }, moment__WEBPACK_IMPORTED_MODULE_2___default()(props.date.toString()).format('dddd, MMMM Do YYYY'))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(DayGrid, {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 46
    },
...
//# sourceMappingURL=schedule.js.0c7b310641028629f571.hot-update.js.map