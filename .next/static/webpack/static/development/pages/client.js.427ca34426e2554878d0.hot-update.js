...
/*!*************************************!*\
  !*** ./components/ReviewMessage.js ***!
  \*************************************/
/*! exports provided: default, TEXT_TEMPLATE_QUERY, SEND_TEXT_MUTATION */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TEXT_TEMPLATE_QUERY", function() { return TEXT_TEMPLATE_QUERY; });
...
var _this = undefined,
    _jsxFileName = "/Users/nickplechas/coding/pday-app/pday-front-master/components/ReviewMessage.js";
...
function _templateObject2() {
  var data = _taggedTemplateLiteral(["\n  query TEXT_TEMPLATE_QUERY($id: ID!) {\n    textTemplate(id: $id) {\n      id\n      name\n      content\n    }\n  }\n"]);
...
var TEXT_TEMPLATE_QUERY = graphql_tag__WEBPACK_IMPORTED_MODULE_3___default()(_templateObject2());
...
var MessageBody = function MessageBody(props) {
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_User__WEBPACK_IMPORTED_MODULE_11__["default"], {
    ...
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_4__["Query"], {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_4__["Query"], {
        query: TEXT_TEMPLATE_QUERY,
        variables: {
          id: _this.state.template
        },
        __source: {
          fileName: _jsxFileName,
          lineNumber: 150
...
function (_Component) {
  ...
  function ReviewMessage() {
    ...
    _this2 = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(ReviewMessage)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_this2), "state", {
      time: '',
      text: _this2.props.seededMessage,
      date: ''
    });

    _defineProperty(_assertThisInitialized(_this2), "saveToState", function (e) {
      ...
      var time = _this2.state.time.length > 0 ? _this2.state.time : '<time>';
      var str = _this2.props.seededMessage;
      var mapObj = {
        '<date>': "".concat(date),
        '<time>': "".concat(time)
      };
    ...
    _defineProperty(_assertThisInitialized(_this2), "saveTime", function (e) {
      ...
      var date = _this2.state.date.length > 7 ? Object(date_fns__WEBPACK_IMPORTED_MODULE_6__["format"])(_this2.state.date, 'ddd, MMM Do') : '<date>';
      var str = _this2.props.seededMessage;
      var time = name;
      var mapObj = {
        '<date>': "".concat(date),
    ...
    _defineProperty(_assertThisInitialized(_this2), "saveTimeMin", function (e) {
      var value = e.target.value;

      var built = _this2.state.time.replace(/(00|15|30|45)/, "".concat(value));
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_4__["Mutation"], {
        ...
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Form, {
          ...
          saveTime: _this3.saveTime,
          time: _this3.state.time,
          saveTimeMin: _this3.saveTimeMin,
          __source: {
            fileName: _jsxFileName,
            lineNumber: 284
          },
          ...
          saveToState: _this3.saveToState,
          __source: {
            fileName: _jsxFileName,
            lineNumber: 289
          },
          ...
          __self: this
        }, _this3.state.text.length, " of 160"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Send, {
...
//# sourceMappingURL=client.js.427ca34426e2554878d0.hot-update.js.map