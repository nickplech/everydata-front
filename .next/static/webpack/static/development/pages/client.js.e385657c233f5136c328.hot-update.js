...
})(["display:block;position:absolute;min-width:300px;width:30%;text-align:center;padding:10px;background:rgba(20,180,110,1);color:white;border-radius:5px;bottom:10px;box-shadow:0 16px 24px 2px rgba(0,0,0,0.1),0 6px 10px 5px rgba(0,0,0,0.1),0 8px 10px -5px rgba(0,0,0,0.2);right:10px;z-index:999;"]);
...
//# sourceMappingURL=client.js.e385657c233f5136c328.hot-update.js.map