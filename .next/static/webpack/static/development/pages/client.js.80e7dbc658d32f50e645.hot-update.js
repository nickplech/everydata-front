...
/*!*******************************!*\
  !*** ./components/Clients.js ***!
  \*******************************/
/*! exports provided: default, ALL_CLIENTS_QUERY, SINGLE_CLIENT_QUERY, SINGLE_MY_CLIENT_QUERY, ALL_CLIENTSUSERS_QUERY */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SINGLE_MY_CLIENT_QUERY", function() { return SINGLE_MY_CLIENT_QUERY; });
...
function _templateObject2() {
  var data = _taggedTemplateLiteral(["\n  query SINGLE_MY_CLIENT_QUERY($userId: ID!, $id: ID!) {\n    myClient(where: { userId: $userId, id: $id }) {\n      id\n      firstName\n      lastName\n      cellPhone\n      birthDay\n    }\n  }\n"]);
...
var SINGLE_MY_CLIENT_QUERY = graphql_tag__WEBPACK_IMPORTED_MODULE_2___default()(_templateObject2());
var ALL_USER_CLIENTS_QUERY = graphql_tag__WEBPACK_IMPORTED_MODULE_2___default()(_templateObject3());
var ALL_CLIENTS_QUERY = graphql_tag__WEBPACK_IMPORTED_MODULE_2___default()(_templateObject4(), _config__WEBPACK_IMPORTED_MODULE_6__["perPage"]);
...
//# sourceMappingURL=client.js.80e7dbc658d32f50e645.hot-update.js.map