...
})(["display:grid;grid-template-columns:minmax(300px 1fr) 1fr 1fr;grid-template-rows:70px 1fr;align-items:flex-end;width:100%;height:100%;padding:20px 20px;z-index:5;border-radius:20px;border:5px solid white;box-shadow:1px 0 4px 2px rgba(0,0,0,0.1);background-color:rgba(240,240,240,1);"]); // const CharCount = styled.div`
//   display: block;
//   font-size: 11px;
//   bottom: 70px;
//   right: 40px;
...
})(["grid-column:3;grid-row:2;position:relative;z-index:6;width:100%;padding:10px;height:100%;border-radius:10px;resize:none;border:none;box-shadow:0 0 4px 3px rgba(0,0,0,0.05);&:focus{outline:none;}"]);
...
//# sourceMappingURL=client.js.6fa8515cc9f6d46b2a90.hot-update.js.map