...
function (_Component) {
  ...
  _createClass(ReviewMessage, [{
    ...
    value: function render() {
      ...
      var twoWeeks = addWeeks(date, 2);
      var result = eachDay(date, twoWeeks);
      var fixedArray = result.splice(-1, 1);
      var oneWeek = addWeeks(date, 1);
      var dayNameResult = eachDay(date, oneWeek);
...
//# sourceMappingURL=client.js.6144bd06da88f939ac57.hot-update.js.map