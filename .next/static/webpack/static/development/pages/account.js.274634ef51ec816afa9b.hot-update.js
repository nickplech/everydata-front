...
})(["padding:5px 20px;margin:4px 1px;border-width:2px;border-style:solid;background:transparent;color:white;width:250px;text-align:center;border-radius:25px;list-style:none;transition:0.2s;&:hover{transform:scale(1.1);box-shadow:1px 1px 4px 3px rgba(0,0,0,0.1);}"]);
...
//# sourceMappingURL=account.js.274634ef51ec816afa9b.hot-update.js.map