...
})(["background:rgba(20,110,240,1);border-radius:50%;display:inline-flex;align-items:center;justify-content:center;height:25px;width:25px;margin:0px 10px;box-shadow:1px 1px 4px 2px rgba(0,0,0,0.3);border:none;position:relative;z-index:20;cursor:pointer;opacity:0.6;outline:none;-webkit-touch-callout:none;-webkit-user-select:none;-khtml-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;&:hover{transform:scale(1.1);}.child{position:absolute;justify-self:center;display:flex;font-family:'Montserrat',sans-serif;color:white;font-size:2.8rem;padding-left:0px;}"]);
...
//# sourceMappingURL=account.js.99e8e8610ab5e159e088.hot-update.js.map