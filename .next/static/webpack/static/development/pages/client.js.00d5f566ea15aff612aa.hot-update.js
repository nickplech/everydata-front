...
})(["border:none;border-radius:50%;align-items:center;justify-content:center;color:white;display:flex;cursor:pointer;position:relative;width:25px;height:25px;&:disabled{opacity:0.4;}"]);
var hourOptions = [{
  value: '1:00',
  label: '1'
}, {
...
//# sourceMappingURL=client.js.00d5f566ea15aff612aa.hot-update.js.map