...
})(["background-color:#fff;border-radius:25px;display:grid;grid-template-rows:50px 1fr 80px;grid-template-columns:1fr 1fr;position:absolute;align-items:center;width:500px;height:500px;overflow:hidden;z-index:900;box-shadow:1px 1px 5px 3px rgba(0,0,0,0.3);.title{grid-column:1/3;font-size:18px;justify-self:center;background:rgba(20,110,220,1);padding:0 200px;color:white;top:0;position:relative;}"]);
...
//# sourceMappingURL=schedule.js.8ca5dce5938ed32d2b52.hot-update.js.map