...
})(["display:inline-flex;flex-flow:row;border-radius:35px;margin:20px 10px;padding:4px 10px;transition:0.3s;align-items:center;justify-content:center;cursor:pointer;&:focus{outline:none;transform:scale(1.1);}&:active{outline:none;transform:scale(1.1);}.picked{border:3px solid black;}"]);
...
var RadioComponent = function RadioComponent(props) {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(StyledButton, {
      style: {
        border: "3px solid ".concat(possibleColors[index]),
        color: "".concat(possibleColors[index])
      },
      type: "button",
      name: "color",
      value: color,
...
//# sourceMappingURL=account.js.d6aae3a8cfd1b2252b97.hot-update.js.map