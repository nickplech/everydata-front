...
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n  mutation SEND_TEXT_MUTATION($to: String!, $text: String!, $client: ID!) {\n    createTextReminder(to: $to, text: $text, client: $client) {\n      id\n      text\n      client {\n        id\n      }\n      confirmationStatus\n    }\n  }\n"]);
...
function (_Component) {
  ...
  function ReviewMessage() {
    ...
    _defineProperty(_assertThisInitialized(_this), "createTextReminder",
    /*#__PURE__*/
    function () {
        ...
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_4__["Mutation"], {
          ...
          return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Back, {
            onSubmit: function onSubmit(e) {
              return _this2.createTextReminder(e, createTextReminder);
            },
            __source: {
              fileName: _jsxFileName,
              lineNumber: 134
            ...
            __self: this
          }, "New Appointment Type Created SuccessFully!"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_4__["Query"], {
            query: TEXT_TEMPLATES_QUERY,
            __source: {
              fileName: _jsxFileName,
              lineNumber: 144
            ...
            var data = _ref4.data;
            return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_DaySelector__WEBPACK_IMPORTED_MODULE_5__["default"], {
              ...
              readOnly: true,
              max: 160,
              defaultValue: data.textTemplates[0].content.replace('<business>', business).replace('<phone>', phone).replace('<time>', time).replace('<date>', date),
              __source: {
                fileName: _jsxFileName,
                lineNumber: 150
              },
...
//# sourceMappingURL=client.js.082fe62bbd925b04e2ca.hot-update.js.map