...
})(["display:flex;padding:10px 0px;align-items:center;justify-content:center;margin:0 auto;margin-top:70px;margin-bottom:70px;background:white;color:gray;border:none;border-radius:35px;width:250px;text-transform:uppercase;font-size:14px;box-shadow:2px 3px 2px 2px rgba(0,0,0,0.2);"]);
...
//# sourceMappingURL=index.js.2b60d5d6281be25d1201.hot-update.js.map