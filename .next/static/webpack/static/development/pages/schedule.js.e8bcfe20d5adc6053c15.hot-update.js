...
})(["background-color:#fff;border-radius:25px;display:grid;grid-template-rows:70px 1fr 80px;grid-template-columns:1fr 1fr;position:absolute;align-items:flex-start;width:500px;height:500px;padding:10px 25px;z-index:900;box-shadow:1px 1px 5px 3px rgba(0,0,0,0.3);.title{grid-column:1/3;font-size:18px;justify-self:center;color:rgba(20,110,220,1);left:0;right:0;top:0;position:relative;}"]);
...
var StyledLabel = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].label.withConfig({
  displayName: "Modal__StyledLabel",
...
//# sourceMappingURL=schedule.js.e8bcfe20d5adc6053c15.hot-update.js.map