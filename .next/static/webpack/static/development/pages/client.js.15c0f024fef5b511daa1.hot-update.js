...
})(["background:white;display:grid;grid-column:2;position:relative;z-index:6;width:95%;padding:10px;height:calc(100% - 50px);border-radius:10px 10px 0 0;align-self:flex-end;resize:none;border:none;box-shadow:0 0 4px 3px rgba(0,0,0,0.05);&:focus{outline:none;}"]);
...
})(["background:rgba(30,110,240,1);color:white;font-weight:800;border:none;width:75px;display:grid;grid-column:2;font-size:2rem;padding:0rem 1.2rem;height:75px;font-size:1.8rem;border-radius:0 0 5px 5px;outline:none;cursor:pointer;box-shadow:0 0 2px 3px rgba(0,0,0,0.05);&:active{box-shadow:none;}&[disabled]{opacity:0.5;}&:hover{background:rgba(30,110,240,0.9);}"]);
...
//# sourceMappingURL=client.js.15c0f024fef5b511daa1.hot-update.js.map