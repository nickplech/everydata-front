...
})(["display:inline-flex;flex-flow:row;border-radius:35px;border:3px solid white,margin:20px 10px;padding:4px 10px;transition:0.3s;align-items:center;justify-content:center;cursor:pointer;&:focus{outline:none;transform:scale(1.1);}&:active{outline:none;transform:scale(1.1);}.picked{border:3px solid black;}"]);
...
//# sourceMappingURL=account.js.50d7f537f33aafc534aa.hot-update.js.map