...
})(["display:flex;margin:2px;width:12.25%;height:40%;color:rgba(20,110,240,0.8);grid-row:3;background:#3d5866;align-content:center;text-align:center;outline:none;border:none;box-shadow:0 0 5px 3px rgba(0,0,0,0.1);cursor:pointer;&:hover{background:lavender;}&:active{background:lavender;}"]);
...
//# sourceMappingURL=client.js.2b57ae15ea4163a598a1.hot-update.js.map