...
})(["display:flex;grid-row:1;grid-column:2;.hour{background:#3d5866;}.min{background:rgba(20,110,240,1);}"]);
...
})(["border:none;border-radius:50%;align-items:center;outline:none;text-align:center;color:white;display:flex;flex-flow:row wrap;cursor:pointer;position:relative;width:25px;height:25px;margin:5px 2px;&:hover{transform:scale(1.1);}&:disabled{opacity:0.4;}"]);
var hourOptions = [{
  value: '1:00',
  label: '1'
}, {
...
//# sourceMappingURL=client.js.bbbd408ec080030eeffd.hot-update.js.map