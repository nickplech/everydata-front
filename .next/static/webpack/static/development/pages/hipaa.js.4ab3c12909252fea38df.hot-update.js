...
})(["display:flex;flex-flow:column;align-items:center;margin:0;padding:20px 0;#root{display:flex;flex-direction:column;width:400px;color:white;font-family:'PT Sans',Helvetica,sans-serif;}h1{margin-bottom:20px;color:Black;text-align:center;}h2{margin:0;color:white;font-size:16px;}.title{cursor:pointer;background-image:linear-gradient( -180deg,rgba(100,100,240,1) 0%,rgba(100,160,220,1) 300px );padding:5px 8px;border-bottom:1px solid rgba(100,100,240,1);}.content{overflow:hidden;font-size:18px;background:rgba(100,220,240,0.4);color:white;}.content-wrapper{padding:5px 8px 20px 8px;}"]);
var data = [{
...
//# sourceMappingURL=hipaa.js.4ab3c12909252fea38df.hot-update.js.map