...
})(["grid-column:2;grid-row:2;position:relative;z-index:6;width:80%;padding:10px;height:100%;max-height:130px;border-radius:10px;font-size:1.5rem;resize:none;border:none;background:rgba(250,250,250,1);box-shadow:0 0 4px 3px rgba(0,0,0,0.05);&:focus{outline:none;}"]);
...
function (_Component) {
  ...
  _createClass(ReviewMessage, [{
    ...
    value: function render() {
      ...
      var date = this.state.date ? Object(date_fns__WEBPACK_IMPORTED_MODULE_6__["format"])(this.state.date, 'ddd, MMM Do') : '<select date>';
...
//# sourceMappingURL=client.js.a4061fbb4da42cb007b0.hot-update.js.map