...
})(["background-color:#fff;border-radius:25px;display:block;position:absolute;align-items:flex-start;width:500px;height:500px;padding:15px 25px;z-index:999;box-shadow:1px 1px 5px 3px rgba(0,0,0,0.3);"]);
...
})(["background:rgba(30,110,240,1);color:white;font-weight:800;border:0;margin:0 auto;display:grid;grid-row:2;border-radius:5px;font-size:2rem;padding:0.5rem 1.2rem;font-size:2rem;display:inline-block;transition:all 0.5s;outline:none;cursor:pointer;box-shadow:1px 1px 4px 2px rgba(0,0,0,0.2);&[disabled]{opacity:0.5;}&:hover{background:rgba(30,110,240,0.9);transform:scale(1.1);}&:active{box-shadow:none;}"]);
...
//# sourceMappingURL=schedule.js.d32b634e182e047e7a43.hot-update.js.map