...
})(["grid-row:2;width:100%;grid-column:1/3;padding:30px 20px;"]);
...
})(["align-self:center;grid-column:1/3;grid-row:1;justify-content:center;border-radius:25px 25px 0 0;background:rgba(20,110,220,1);overflow:hidden;padding:0px 20px 0px 20px;p{margin:0;font-size:18px;position:relative;color:white;}.title{display:flex;font-size:18px;margin:0;color:white;position:relative;}h3{margin:0;}"]);
...
//# sourceMappingURL=signup.js.716100798a91485632ec.hot-update.js.map