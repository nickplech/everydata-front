...
})(["display:grid;grid-template-columns:1fr;grid-auto-rows:30px;grid-gap:1px;width:100%;border-bottom:1px solid grey;margin-top:90px;height:75vh;overflow-y:scroll;overscroll-behavior:contain;.timeCell{display:flex;padding-left:5px;align-items:center;border-bottom:none;border-top:1px solid grey;border-left:5px solid lightblue;background:rgba(100,100,240,0.2);color:grey;&:hover{background:lightblue;opacity:0.4;}}.lower{display:flex;padding-left:5px;align-items:center;border-bottom:none;border-top:1px solid grey;border-left:5px solid lightblue;background:rgba(240,240,240,0.4);color:grey;&:hover{background:lightblue;opacity:0.4;}}"]);
var DUMMY_DATA = [{
  time: 6,
  am: true,
  q2: 615,
...
//# sourceMappingURL=schedule.js.ec2a62ee7eb2b42ac6fc.hot-update.js.map