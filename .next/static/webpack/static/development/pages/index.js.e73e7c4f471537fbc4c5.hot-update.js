...
})(["font-family:'Montserrat',sans-serif;z-index:5;margin-top:270px;.confirmation{color:rgba(100,240,100,1);}p{position:relative;margin:0;display:block;max-width:700px;z-index:5;color:white;font-size:1.5rem;padding-left:20%;}.title{position:relative;display:block;margin-bottom:0px;color:white;font-weight:600;padding-left:20%;font-size:2.7rem;}"]);
...
})(["background:transparent;border:2px solid white;padding-left:20%;padding:8px 12px;margin-top:5px;color:white;border-radius:5px;font-size:16px;"]);
...
//# sourceMappingURL=index.js.e73e7c4f471537fbc4c5.hot-update.js.map