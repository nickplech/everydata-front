...
})(["display:inline-block;padding-right:10px;padding-left:10px;padding-top:5px;transition:all 300ms cubic-bezier(0.4,0,0.2,1) 0ms;margin:50px 3px 0 3px;cursor:pointer;border:1px solid grey;opacity:0.4;border-bottom:none;background:rgba(20,110,220,1);&:hover{opacity:1;}&:focus{background:rgba(20,110,220,1);}&:nth-child(1){border-radius:10px 0 0 0;}&:nth-child(3){border-radius:0px 10px 0 0;}"]);
...
//# sourceMappingURL=account.js.c92abacfd34ad2f2d125.hot-update.js.map