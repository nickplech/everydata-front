...
})(["display:grid;grid-column:1;text-align:left;font-weight:800;color:grey;background:transparent;border:none;opacity:1;cursor:pointer;&:focus{outline:none;}&:nth-child(4n + 2){display:grid;grid-column:1/3;align-items:center;border:2px solid rgba(20,110,240,0.65);border-radius:20px 0 0 20px;background:transparent;color:rgba(20,110,240,0.65);border-right:none;}"]);
...
})(["display:grid;border-left:none;grid-column:2/3;padding-left:5px;align-items:center;border-bottom:none;border-top:0px solid white;background:rgba(243,241,244,1);cursor:pointer;&:hover{opacity:0.5;}.number{display:grid;font-size:12px;align-self:center;justify-content:flex-start;-webkit-touch-callout:none;-webkit-user-select:none;-khtml-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;}"]);
...
//# sourceMappingURL=schedule.js.b427bb4526a2869162fb.hot-update.js.map