...
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n  mutation updateUser($permissions: [Permission], $userId: ID!) {\n    updateUser(\n      userId: $userId\n      name: $name\n      businessName: $businessName\n      email: $email\n    ) {\n      id\n      permissions\n      name\n      email\n    }\n  }\n"]);
...
function (_Component) {
  ...
  function UpdateUserProfile() {
    ...
    function () {
      ...
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(e, updatePermissionsMutation) {
        var res;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                e.preventDefault();
                _context.next = 3;
                return updatePermissionsMutation({
                  variables: {
                    name: '',
                    businessName: '',
                    email: ''
...
//# sourceMappingURL=account.js.a67bc78fe4c75b134f0e.hot-update.js.map