...
})(["background-color:#fff;border-radius:25px;display:grid;grid-template-rows:70px 1fr 40px;grid-template-columns:1fr 1fr;position:absolute;align-items:flex-start;width:500px;height:500px;padding:10px 25px;z-index:900;box-shadow:1px 1px 5px 3px rgba(0,0,0,0.3);.title{grid-column:1/3;font-size:18px;justify-self:center;color:rgba(20,110,220,1);left:0;right:0;top:0;position:relative;}"]);
...
})(["width:100%;padding:10px;padding-top:3px;border:0;font-size:2rem;outline:none;"]);
...
//# sourceMappingURL=schedule.js.4349a93b253c6a5588e4.hot-update.js.map