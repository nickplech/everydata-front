...
})(["height:45vh;padding:100px 0;flex-flow:column;justify-content:stretch;align-items:center;display:flex;background:#f4f3fa;svg{margin-left:10px;}.lead{font-family:'Montserrat',sans-serif;font-size:2.2rem;line-height:2.9rem;max-width:700px;text-align:center;font-weight:200;}button{display:flex;border:none;text-align:center;width:auto;overflow:visible;background:transparent;-webkit-font-smoothing:inherit;-moz-osx-font-smoothing:inherit;-webkit-appearance:none;background:transparent;outline:none;color:white;padding:15px 20px;cursor:pointer;color:rgb(70,200,120);font-size:3rem;font-family:'Montserrat',sans-serif;font-weight:200;}"]);
var paths = {
  ...
  _createClass(IconMorph, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(StyledBody, {
        ...
        __self: this
      }, "Take control of your business' schedule and communicate with your clients in the most relevant and effective way possible."));
    }
  }]);
...
//# sourceMappingURL=index.js.0e5190846db45afbc2d1.hot-update.js.map