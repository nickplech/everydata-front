  ...
  function ReviewMessage() {
    ...
    _defineProperty(_assertThisInitialized(_this), "saveTimeMin", function (e) {
      ...
      if (_this.state.time.includes('15')) {
        var _built = _this.state.time.replace('15', "".concat(value));
      ...
      if (_this.state.time.includes('30')) {
        var _built2 = _this.state.time.replace('30', "".concat(value));
      ...
      if (_this.state.time.includes('45')) {
        var _built3 = _this.state.time.replace('45', "".concat(value));

        _this.setState({
          time: _built3
        });
      } else {
        var _built4 = _this.state.time.replace('00', "".concat(value));
...
//# sourceMappingURL=client.js.3dec2a649778089079a8.hot-update.js.map