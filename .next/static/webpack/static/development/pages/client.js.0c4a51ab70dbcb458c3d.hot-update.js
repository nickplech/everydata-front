...
function (_Component) {
  ...
  function ReviewMessage() {
    ...
    _defineProperty(_assertThisInitialized(_this), "saveToState", function (e) {
      ...
      var fix = function fix(date, time) {
        var textTemplate = _this.state.text.replace('<time>', "".concat(time)).replace('<date', "".concat(date));
...
//# sourceMappingURL=client.js.0c4a51ab70dbcb458c3d.hot-update.js.map