...
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n  mutation DELETE_CLIENT_MUTATION($id: ID!, $firstName: String) {\n    deleteClient(id: $id, firstName: $firstName) {\n      id\n      firstName\n    }\n  }\n"]);
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_1__["Mutation"], {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
          onClick: function onClick() {
            if (confirm("'Are you sure you want to delete ".concat(_this2.props.firstName, "'"))) {
...
//# sourceMappingURL=clients.js.509f8e7b01b0ed5d7901.hot-update.js.map