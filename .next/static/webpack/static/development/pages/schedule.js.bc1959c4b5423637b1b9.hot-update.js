...
})(["align-self:center;grid-column:1/3;grid-row:1;justify-content:center;border-radius:25px 25px 0 0;overflow:hidden;height:100%;p{margin:0;border:2px solid ", ";border-radius:5px;font-family:'Montserrat',sans-serif;color:", ";display:block;text-align:center;padding:0px 0px;padding:5px 20px 0px 20px;font-size:2.2rem;position:relative;}h3{margin:0;}"], function (props) {
...
//# sourceMappingURL=schedule.js.bc1959c4b5423637b1b9.hot-update.js.map