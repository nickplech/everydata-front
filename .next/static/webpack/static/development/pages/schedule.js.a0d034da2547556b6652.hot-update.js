...
})(["position:relative;display:grid;grid-row:1/3;grid-column:2/3;width:100%;height:100%;background-color:transparent;box-shadow:0 0 5px 3px rgba(0,0,0,0.05);border:5px solid white;border-radius:25px;z-index:-1;.parent{display:flex;justify-content:center;}.date{display:flex;padding-top:7px;color:rgba(100,120,220,1);}.sideDate{display:flex;position:absolute;justify-self:flex-end;}"]);
...
//# sourceMappingURL=schedule.js.a0d034da2547556b6652.hot-update.js.map