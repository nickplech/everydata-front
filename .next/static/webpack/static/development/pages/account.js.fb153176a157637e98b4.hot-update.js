...
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n  mutation createOrder($token: String!, $plan: String!, $price: Int, $id: ID!) {\n    createOrder(token: $token, plan: $plan, price: $price, id: $id) {\n      id\n      plan\n      charge\n      total\n    }\n  }\n"]);
...
//# sourceMappingURL=account.js.fb153176a157637e98b4.hot-update.js.map