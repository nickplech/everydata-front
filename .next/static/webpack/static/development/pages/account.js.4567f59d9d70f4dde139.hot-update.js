...
})(["background:green;border-radius:50%;display:flex;align-items:center;justify-content:center;height:30px;width:30px;padding-bottom:6px;border:1px solid green;position:relative;z-index:20;transform:rotateZ(45deg);cursor:pointer;opacity:0.6;outline:none;&:hover{transform:scale(1.1);}.child{position:absolute;justify-self:center;display:flex;color:white;font-size:3rem;padding-left:0px;}"]);
...
//# sourceMappingURL=account.js.4567f59d9d70f4dde139.hot-update.js.map