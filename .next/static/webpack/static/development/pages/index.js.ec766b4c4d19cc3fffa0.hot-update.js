...
var Screen = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].img.withConfig({
...
var HeroButton = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].button.withConfig({
  displayName: "Hero__HeroButton",
  componentId: "sc-1vorxnl-4"
})(["display:inline-block;background:transparent;border:2px solid white;margin-left:20%;padding:8px 12px;margin-top:15px;color:white;border-radius:5px;font-size:18px;cursor:pointer;&:hover{transition:0.2s;transform:scale(1.05);color:white;}&:active{transform:scale(1);}"]);
var SecondButton = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].button.withConfig({
  displayName: "Hero__SecondButton",
  componentId: "sc-1vorxnl-5"
})(["display:inline-block;background:rgba(100,100,220,1);border:2px solid rgba(100,100,220,1);margin-left:25px;padding:8px 12px;width:200px;margin-top:15px;color:white;border-radius:5px;font-size:18px;cursor:pointer;&:hover{transition:0.2s;transform:scale(1.05);color:white;}&:active{transform:scale(1);}}"]);
...
//# sourceMappingURL=index.js.ec766b4c4d19cc3fffa0.hot-update.js.map