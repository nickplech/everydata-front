...
})(["display:flex;margin:2px;width:12.25%;height:40%;color:white;grid-row:3;background:#3d5866;align-content:center;text-align:center;outline:none;border:none;box-shadow:0 0 5px 3px rgba(0,0,0,0.1);cursor:pointer;&:first-child{background:rgba(20,110,240,0.6);}&:hover{opacity:0.7;}&:active{background:lavender;}"]);
...
//# sourceMappingURL=client.js.75c7d10f14b05f4c11b8.hot-update.js.map