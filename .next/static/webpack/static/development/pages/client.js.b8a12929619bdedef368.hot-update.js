  ...
  function ReviewMessage() {
    ...
    _defineProperty(_assertThisInitialized(_this), "saveTimeMin", function (e) {
      ...
      if (_this.state.time.includes('30')) {
        var _built = _this.state.time.replace('30', "".concat(value));
      ...
      if (_this.state.time.includes('45')) {
        var _built2 = _this.state.time.replace('45', "".concat(value));

        _this.setState({
          time: _built2
        });
      } else {
        var _built3 = _this.state.time.replace('00', "".concat(value));
...
//# sourceMappingURL=client.js.b8a12929619bdedef368.hot-update.js.map