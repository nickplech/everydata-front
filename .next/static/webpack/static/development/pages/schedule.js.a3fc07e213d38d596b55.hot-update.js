...
})(["display:grid;position:relative;grid-template-columns:60px 1fr;grid-auto-rows:30px;border-radius:15px;grid-gap:1px;width:50%;margin-left:25px;margin-top:10px;height:70vh;overflow-y:scroll;overscroll-behavior:contain;.timeCell{display:grid;grid-column:2/3;margin-top:2px;padding-left:5px;align-items:center;border-bottom:none;border-top:1px solid white;background:rgba(100,100,240,0.2);color:grey;&:hover{opacity:0.5;}}.lower{display:grid;grid-column:2/3;padding-left:5px;align-items:center;border-bottom:none;border-top:1px solid white;background:rgba(243,241,244,1);color:grey;&:hover{opacity:0.5;}}.number{grid-column:1/3;height:100%;background:lightblue;margin-top:2px;border-bottom:none;}"]);
var DUMMY_DATA = [{
  time: 8,
  am: true,
  q2: 815,
...
//# sourceMappingURL=schedule.js.a3fc07e213d38d596b55.hot-update.js.map