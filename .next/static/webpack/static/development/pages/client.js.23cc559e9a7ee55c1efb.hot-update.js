...
})(["display:grid;grid-template-columns:60% 40%;grid-template-rows:1fr 50px;position:relative;flex-flow:column;width:100%;height:100%;align-self:flex-start;justify-content:center;"]); // const CharCount = styled.div`
//   display: block;
//   font-size: 11px;
//   bottom: 70px;
//   right: 40px;
...
})(["background:white;display:grid;grid-column:2;position:relative;z-index:6;width:95%;height:calc(100% - 40px);border-radius:10px;align-self:center;justify-self:center;"]);
...
})(["background:rgba(30,110,240,1);color:white;font-weight:800;border:0;width:95%;display:grid;grid-column:2;font-size:2rem;justify-self:center;padding:0rem 1.2rem;height:90%;font-size:1.8rem;border-radius:5px;outline:none;cursor:pointer;box-shadow:1px 1px 2px 1px rgba(0,0,0,0.15);&:active{box-shadow:none;}&[disabled]{opacity:0.5;}&:hover{background:rgba(30,110,240,0.9);}"]);
...
//# sourceMappingURL=client.js.23cc559e9a7ee55c1efb.hot-update.js.map