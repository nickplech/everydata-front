...
})(["position:relative;display:grid;grid-row:1/3;grid-column:2/3;width:100%;height:100%;background-color:transparent;box-shadow:0 0 5px 3px rgba(0,0,0,0.05);border:5px solid white;border-radius:25px;z-index:-1;@import url('https://fonts.googleapis.com/css?family=Gruppo|Khmer|Major+Mono+Display|Orbitron|Spinnaker');.parent{display:block;text-align:center;}.date{display:inline-block;text-transform:uppercase;margin-bottom:0;color:rgba(100,120,220,1);}.sideDate{display:inline-block;position:absolute;right:20px;margin:0;font-family:'Major Mono Display',monospace;font-size:26px;}"]);
...
//# sourceMappingURL=schedule.js.940f7a6b569c094c1550.hot-update.js.map