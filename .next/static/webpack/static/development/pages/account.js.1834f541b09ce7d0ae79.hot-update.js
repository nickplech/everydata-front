...
})(["padding:3px 10px;margin:4px 5px;border-width:2px;border-style:solid;background:transparent;color:", ";min-width:50px;text-align:center;cursor:pointer;border-radius:25px;list-style:none;transition:0.2s;&:hover{transform:scale(1.1);box-shadow:1px 1px 4px 3px rgba(0,0,0,0.1);}"], function (props) {
  return props.reason.color === '#F8F8FF' && 'black';
});
...
//# sourceMappingURL=account.js.1834f541b09ce7d0ae79.hot-update.js.map