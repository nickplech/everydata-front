...
function (_Component) {
  ...
  function SingleClient(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "scrollToBottom", function () {
      window.scrollTo(0, _this.myRef.current.offsetTop);
    });

    _this.myRef = react__WEBPACK_IMPORTED_MODULE_0___default.a.createRef(); // Create a ref object
...
//# sourceMappingURL=client.js.e67dd3474204a8fdc21f.hot-update.js.map