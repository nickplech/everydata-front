...
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n  mutation SEND_TEXT_MUTATION(\n    $to: String!\n    $from: String!\n    $text: String!\n    $client: ID!\n  ) {\n    createTextReminder(to: $to, from: $from, text: $text, client: $client) {\n      id\n      text\n      client {\n        id\n      }\n      confirmationStatus\n    }\n  }\n"]);
...
var TEXT_TEMPLATES_QUERY = graphql_tag__WEBPACK_IMPORTED_MODULE_2___default()(_templateObject2());
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_User__WEBPACK_IMPORTED_MODULE_7__["default"], {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Back, {
          ...
          __self: this
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Mutation, {
          muation: SEND_TEXT_MUTATION,
          variable: {
          ...
          return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_DaySelector__WEBPACK_IMPORTED_MODULE_4__["default"], {
            ...
            __self: this
          }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_TimePicker__WEBPACK_IMPORTED_MODULE_6__["default"], {
            __source: {
              fileName: _jsxFileName,
              lineNumber: 135
            },
            ...
            readOnly: true,
            max: 160,
            value: data.textTemplates[0].content.replace('<business>', business).replace('<phone>', phone).replace('<time>', time).replace('<date>', Object(date_fns__WEBPACK_IMPORTED_MODULE_5__["format"])(date, 'MMM Do')),
            __source: {
              fileName: _jsxFileName,
              lineNumber: 136
            },
...
//# sourceMappingURL=client.js.41997d2e9d117b64093c.hot-update.js.map