...
})(["display:inline-flex;flex-flow:row;border-radius:30px;margin:0 10px;padding:4px 10px;transition:0.3s;align-items:center;justify-content:center;cursor:pointer;&:focus{outline:none;transform:scale(1.2);}.picked{border:3px solid black;}"]);
...
//# sourceMappingURL=account.js.3993190b5e5cdf945ade.hot-update.js.map