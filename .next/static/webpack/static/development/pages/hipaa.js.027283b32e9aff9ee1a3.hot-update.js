...
})(["display:inline-flex;align-content:center;justify-content:center;width:30px;height:30px;background:white;border:2px solid white;border-radius:50%;.plus{display:inline-flex;align-self:center;justify-self:center;text-align:center;margin-right:40px;color:purple;font-size:25px;}"]);
var data = [{
...
//# sourceMappingURL=hipaa.js.027283b32e9aff9ee1a3.hot-update.js.map