...
var BackDrop = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].div.withConfig({
  displayName: "TextMessages__BackDrop",
  componentId: "zami5e-0"
})(["display:grid;grid-row:1/3;grid-column:2/3;width:100%;height:100%;box-shadow:0 0 5px 3px rgba(0,0,0,0.05);border:5px solid white;border-radius:25px;z-index:-1;"]);
var TextMessage = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].div.withConfig({
  displayName: "TextMessages__TextMessage",
  componentId: "zami5e-1"
})(["position:relative;display:grid;grid-row:1/2;grid-column:2/3;width:100%;height:100%;background-color:transparent;"]);
  ...
  _createClass(TextMessages, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(BackDrop, {
        ...
        __self: this
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(TextMessage, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 33
        },
...
//# sourceMappingURL=client.js.83ea72dabdef2d77c98e.hot-update.js.map