...
})(["background:rgba(30,110,240,1);color:white;font-weight:800;border:0;width:95%;display:grid;grid-column:2;font-size:2rem;padding:0rem 1.2rem;height:70%;font-size:1.8rem;border-radius:0 0 5px 5px;outline:none;cursor:pointer;box-shadow:1px 1px 2px 1px rgba(0,0,0,0.15);&:active{box-shadow:none;}&[disabled]{opacity:0.5;}&:hover{background:rgba(30,110,240,0.9);}"]);
...
//# sourceMappingURL=client.js.e941d95ddfee9668a539.hot-update.js.map