...
})(["img{width:100%;height:100px;object-fit:cover;}.buttonList{text-align:left;display:grid;width:100%;align-items:center;grid-template-columns:repeat(auto-fit,minmax(100px,1fr));& > *{background:white;&:hover{background:rgba(100,100,240,0.4);}}}p,a{padding-left:10px;}button{cursor:pointer;&:hover{background:rgba(100,100,240,0.4);}}"]);
/* harmony default export */ __webpack_exports__["default"] = (ClientStyles);

/***/ })

})
//# sourceMappingURL=clients.js.7738108320f7c851c5ee.hot-update.js.map