...
})(["display:grid;position:relative;grid-template-columns:40px 1fr;grid-auto-rows:30px;border-radius:15px;grid-gap:1px;width:50%;margin-left:15px;margin-top:10px;height:70vh;overflow-y:scroll;overscroll-behavior:contain;.timeCell{display:grid;grid-columns:2/3;margin-top:2px;padding-left:5px;align-items:center;border-bottom:none;border-top:1px solid white;border-right:2px solid white;border-left:5px solid lightblue;background:rgba(100,100,240,0.2);color:grey;&:hover{opacity:0.5;}}.lower{display:grid;grid-columns:2/3;padding-left:5px;align-items:center;border-bottom:none;border-top:1px solid white;border-left:5px solid lightblue;border-right:2px solid white;background:rgba(243,241,244,1);color:grey;&:hover{opacity:0.5;}}"]);
var DUMMY_DATA = [{
  time: 8,
  am: true,
  q2: 815,
...
//# sourceMappingURL=schedule.js.0973621b7d85e708b05a.hot-update.js.map