...
var _jsxFileName = "/Users/nickplechas/coding/everyData/everydata-front/components/Block.js";


var Tabs = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
  displayName: "Block__Tabs",
  componentId: "ksnbbt-0"
})(["display:flex;padding:10px;min-width:150px;height:45px;justify-content:center;align-content:center;align-items:center;transition:all 400ms cubic-bezier(0.4,0,0.2,1) 0ms;.textWhite{color:white;text-transform:uppercase;font-size:10px;}"]);
...
var _jsxFileName = "/Users/nickplechas/coding/everyData/everydata-front/components/Header.js";
...
var Logo = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].h1.withConfig({
  ...
  componentId: "sc-1vrrt25-0"
})(["font-size:1.5rem;margin-left:2rem;display:flex;align-self:center;justify-self:center;position:relative;z-index:0;a{padding:0rem 1rem;background:white;color:rgba(10,110,240,1);text-decoration:none;}"]);
var StyledHeader = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].header.withConfig({
  displayName: "Header__StyledHeader",
  componentId: "sc-1vrrt25-1"
})(["position:fixed;width:100%;background:rgba(10,110,240,1);z-index:1000;.bar{display:grid;grid-template-columns:auto 1fr;background:rgba(10,110,240,1);justify-content:space-between;align-items:center;}"]);
...
var Header = function Header() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(StyledHeader, {
    ...
    __self: this
  }, "EveryData"))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Nav__WEBPACK_IMPORTED_MODULE_3__["default"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 79
    },
...
/* harmony import */ var _User__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./User */ "./components/User.js");
var _jsxFileName = "/Users/nickplechas/coding/everyData/everydata-front/components/Signout.js";
...
var NavStyles = styled_components__WEBPACK_IMPORTED_MODULE_0__["default"].ul.withConfig({
  ...
  componentId: "rwo18o-0"
})(["margin:0;padding:0;display:flex;justify-self:end;font-size:1rem;z-index:0;background:rgba(20,110,240,1);position:relative;a,button{padding:0rem 2rem;display:flex;align-items:center;position:relative;text-transform:uppercase;font-weight:900;font-size:1em;background:none;border:none;color:white;z-index:5;cursor:pointer;&:after{height:100%;background:white;content:'", "';width:0;color:rgba(20,110,240,1);position:absolute;transform:translateX(-50%);transition:width 0.4s;transition-timing-function:cubic-bezier(1,-0.65,0,2.31);left:50%;}@media (max-width:699px){&:after{height:0;background:none;content:'';width:0;position:absolute;transform:none;transition:none;left:50%;}}&:hover,&:focus{outline:none;&:after{width:calc(100% - 60px);}}}@media (max-width:1300px){width:100%;justify-content:flex-end;font-size:1.5rem;}"], function (props) {
...
//# sourceMappingURL=_app.js.0ac22d3f822ae8b7b904.hot-update.js.map