...
})(["*{margin:0;padding:0;}body{height:100vh;padding:0;justify-content:center;align-items:flex-start;display:flex;}#root{display:flex;flex-direction:column;width:400px;color:white;font-family:'PT Sans',Helvetica,sans-serif;}h1{margin-bottom:20px;color:Black;text-align:center;}.title{cursor:pointer;background-image:linear-gradient( -180deg,rgba(100,100,240,1) 0%,rgba(100,150,240,1) 300px );padding:5px 8px;border-bottom:1px solid #9f0092;}.content{overflow:hidden;font-size:18px;background:rgba(0,0,0,0.8);color:white;}.content-wrapper{padding:5px 8px 20px 8px;}"]);
var data = [{
...
//# sourceMappingURL=hipaa.js.dbe5c3e7ac3c60aec095.hot-update.js.map