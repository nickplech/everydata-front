...
})(["display:grid;grid-template-columns:1fr;grid-auto-rows:30px;grid-gap:1px;width:100%;margin-top:20px;height:95%;overflow-y:scroll;overscroll-behavior:contain;.timeCell{display:flex;padding-left:5px;align-items:center;border-bottom:none;border-top:1px solid grey;border-left:5px solid blue;color:grey;}"]);
var DUMMY_DATA = [{
  time: 6,
  am: true
}, {
...
//# sourceMappingURL=schedule.js.6d3c02b4e3b9b292fc15.hot-update.js.map