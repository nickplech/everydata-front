...
var SickButton = styled_components__WEBPACK_IMPORTED_MODULE_5__["default"].a.withConfig({
  displayName: "Modal__SickButton",
  componentId: "sc-105rmtf-5"
})(["background:rgba(30,110,240,1);color:white;font-weight:800;border:0;margin:0 auto;display:grid;grid-row:2;border-radius:5px;font-size:2rem;float:left;padding:0.5rem 1.2rem;font-size:2rem;display:inline-block;transition:all 0.5s;outline:none;cursor:pointer;box-shadow:1px 1px 4px 2px rgba(0,0,0,0.2);&[disabled]{opacity:0.5;}&:hover{background:rgba(30,110,240,0.9);}&:active{box-shadow:none;}"]);
var SickerButton = styled_components__WEBPACK_IMPORTED_MODULE_5__["default"].a.withConfig({
  displayName: "Modal__SickerButton",
  componentId: "sc-105rmtf-6"
})(["background:rgba(10,120,240,1);color:white;font-weight:800;border:0;margin:10px 20px;border-radius:5px;font-size:2rem;float:right;padding:0.5rem 1.2rem;font-size:1.8rem;transition:all 0.5s;outline:none;cursor:pointer;box-shadow:1px 1px 4px 2px rgba(0,0,0,0.2);&[disabled]{opacity:0.5;}&:hover{background:rgba(230,10,40,0.7);}&:active{box-shadow:none;}"]);
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_2__["Mutation"], {
        ...
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_2__["Query"], {
          ...
          return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(BackDrop, {
            ...
            __self: this
          }, "Save"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(SickerButton, {
            onClick: toggleModal,
            __source: {
              fileName: _jsxFileName,
              lineNumber: 282
...
//# sourceMappingURL=schedule.js.9d7997d502e7a491cf77.hot-update.js.map