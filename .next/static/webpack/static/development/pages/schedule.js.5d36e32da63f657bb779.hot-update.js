...
})(["background-color:#fff;border-radius:25px;display:grid;grid-template-rows:50px 1fr 80px;grid-template-columns:1fr 1fr;position:absolute;align-items:center;width:500px;height:500px;z-index:900;box-shadow:1px 1px 5px 3px rgba(0,0,0,0.3);.title{grid-column:1/3;font-size:18px;align-self:center;background:rgba(20,110,220,1);width:100%;color:white;}"]);
...
//# sourceMappingURL=schedule.js.5d36e32da63f657bb779.hot-update.js.map