...
})(["display:grid;grid-template-columns:100%;grid-auto-rows:20px;background-color:rgba(20,20,100,0.1);max-width:100%;grid-gap:10px;margin-top:15px;margin-bottom:15px;padding-right:10px;padding-left:10px;padding-top:0px;overflow-y:scroll;padding-bottom:0px;border:1px solid rgba(0,0,0,0.2);border-radius:5px;"]);
...
//# sourceMappingURL=clients.js.52011d564a443f532238.hot-update.js.map