...
})(["background:transparent;color:red;font-weight:800;border:3px solid red;margin:10px 20px;border-radius:50%;font-size:2rem;float:right;padding:0.5rem 1.2rem;font-size:1.8rem;transition:all 0.5s;outline:none;cursor:pointer;box-shadow:1px 1px 4px 2px rgba(0,0,0,0.2);&[disabled]{opacity:0.5;}&:hover{background:rgba(230,10,40,0.7);}&:active{box-shadow:none;}"]);
...
//# sourceMappingURL=schedule.js.b66acdc6e5df5e66c7ae.hot-update.js.map