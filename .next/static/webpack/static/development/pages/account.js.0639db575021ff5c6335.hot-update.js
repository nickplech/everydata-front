...
})(["display:inline-flex;flex-flow:row;justify-self:center;border-radius:35px;border:3px solid white;color:white;margin:20px 10px;padding:4px 10px;transition:0.3s;align-items:center;justify-content:center;-webkit-touch-callout:none;-webkit-user-select:none;-khtml-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;cursor:pointer;&:focus{outline:none;transform:scale(1.1);}&:active{outline:none;transform:scale(1.1);}&:hover{opacity:0.9;transform:scale(1.1);}.picked{border:3px solid black;}"]);
...
//# sourceMappingURL=account.js.0639db575021ff5c6335.hot-update.js.map