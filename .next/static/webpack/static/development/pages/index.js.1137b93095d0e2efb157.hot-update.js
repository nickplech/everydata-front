...
})(["display:inline-block;background:transparent;border:2px solid white;margin-left:20%;padding:8px 12px;margin-top:15px;color:white;border-radius:5px;font-size:18px;cursor:pointer;&:hover{border-color:rgba(100,100,220,1);transform:scale(1.1);color:white;}"]);
...
//# sourceMappingURL=index.js.1137b93095d0e2efb157.hot-update.js.map