...
})(["background:transparent;color:red;font-weight:800;display:flex;position:relative;border:3px solid red;margin:10px 15px;border-radius:50%;font-size:2rem;float:right;padding:0.4rem 0.8rem;font-size:1.8rem;transition:all 0.5s;outline:none;cursor:pointer;box-shadow:1px 1px 4px 2px rgba(0,0,0,0.2);&[disabled]{opacity:0.5;}&:hover{background:rgba(230,10,40,0.5);color:white;border-color:white;transform:scale(1.1);}&:active{box-shadow:none;}"]);
...
//# sourceMappingURL=schedule.js.1ba97f47ca984405f1f5.hot-update.js.map