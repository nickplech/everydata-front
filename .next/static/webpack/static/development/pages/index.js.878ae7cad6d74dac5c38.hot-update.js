...
})(["display:flex;padding:20px 0px;align-items:center;justify-content:center;background:white;color:gray;border:none;border-radius:40px;width:250px;text-transform:uppercase;font-size:16px;box-shadow:2px 3px 2px 2px rgba(0,0,0,0.2);&:focus,&:active{outline:none;}"]);
...
//# sourceMappingURL=index.js.878ae7cad6d74dac5c38.hot-update.js.map