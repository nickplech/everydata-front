...
})(["background:transparent;color:red;font-weight:800;border:3px solid red;margin:10px 20px;border-radius:50%;font-size:2rem;float:right;padding:0.4rem 0.8rem;font-size:1.8rem;transition:all 0.5s;outline:none;cursor:pointer;box-shadow:1px 1px 4px 2px rgba(0,0,0,0.2);&[disabled]{opacity:0.5;}&:hover{background:rgba(230,10,40,0.5);color:white;}&:active{box-shadow:none;}"]);
...
//# sourceMappingURL=schedule.js.08ebe7b30a0269b0ea85.hot-update.js.map