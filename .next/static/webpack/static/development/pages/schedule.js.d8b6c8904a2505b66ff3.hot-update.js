...
})(["display:grid;grid-template-columns:1fr;grid-auto-rows:20px;grid-gap:0.5px;width:100%;border:none;margin-top:20px;height:95%;overflow-y:scroll;overscroll-behavior:contain;.timeCell{display:flex;align-items:center;color:grey;border:1px solid grey;}"]);
var DUMMY_DATA = [{
  time: 6,
  am: true
}, {
...
//# sourceMappingURL=schedule.js.d8b6c8904a2505b66ff3.hot-update.js.map