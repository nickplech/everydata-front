...
})(["grid-row:1;grid-column:1;.hour{background:rgba(10,20,40,1);}.min{background:rgba(10,20,140,1);}"]);
...
})(["border:none;border-radius:5px;justify-content:center;flex-direction:row;display:flex;cursor:pointer;position:relative;width:50px;height:25px;"]);
var hourOptions = [{
  value: '1:00',
  label: '1'
}, {
...
//# sourceMappingURL=client.js.29629e66392040389ca1.hot-update.js.map