...
function (_Component) {
  ...
  function ReviewMessage() {
    ...
    _defineProperty(_assertThisInitialized(_this), "saveToState", function (e) {
      ...
      var time = _this.state.time.length >= 1 ? _this.state.time : '<time>';
    ...
    _defineProperty(_assertThisInitialized(_this), "saveTime", function (e) {
      ...
      var date = _this.state.date.length > 1 ? Object(date_fns__WEBPACK_IMPORTED_MODULE_6__["format"])(_this.state.date, 'ddd, MMM Do') : '<date>';

      var textTemplate = _this.props.seededMessage.replace('<date>', date, '<time>', val);
...
//# sourceMappingURL=client.js.8b3ef96fff1044ad5ccd.hot-update.js.map