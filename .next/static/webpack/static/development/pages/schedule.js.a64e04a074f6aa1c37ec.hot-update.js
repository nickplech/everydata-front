...
})(["background-color:#fff;border-radius:25px;display:block;position:absolute;width:500px;height:500px;padding:15px 25px;z-index:999;box-shadow:1px 1px 5px 3px rgba(0,0,0,0.3);"]);
...
})(["background:rgba(30,110,240,1);color:white;font-weight:800;border:0;margin:20px auto;display:flex;justify-self:flex-end;border-radius:5px;font-size:2rem;padding:0.5rem 1.2rem;font-size:2rem;transition:all 0.5s;outline:none;cursor:pointer;box-shadow:1px 1px 4px 2px rgba(0,0,0,0.2);&[disabled]{opacity:0.5;}&:hover{background:rgba(30,110,240,0.9);transform:scale(1.1);}&:active{box-shadow:none;}"]);
...
})(["background:transparent;color:red;font-weight:800;border:3px solid red;margin:10px 20px;border-radius:50%;font-size:2rem;float:right;padding:0.4rem 0.8rem;font-size:1.8rem;transition:all 0.5s;outline:none;cursor:pointer;box-shadow:1px 1px 4px 2px rgba(0,0,0,0.2);&[disabled]{opacity:0.5;}&:hover{background:rgba(230,10,40,0.5);color:white;border-color:white;transform:scale(1.1);}&:active{box-shadow:none;}"]);
...
//# sourceMappingURL=schedule.js.a64e04a074f6aa1c37ec.hot-update.js.map