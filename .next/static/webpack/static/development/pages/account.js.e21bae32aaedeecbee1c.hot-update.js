...
})(["display:inline-flex;flex-flow:row;border-radius:35px;margin:20px 10px;padding:4px 10px;transition:0.3s;align-items:center;justify-content:center;cursor:pointer;&:focus{outline:none;transform:scale(1.2);}.picked{border:3px solid black;}"]);
...
//# sourceMappingURL=account.js.e21bae32aaedeecbee1c.hot-update.js.map