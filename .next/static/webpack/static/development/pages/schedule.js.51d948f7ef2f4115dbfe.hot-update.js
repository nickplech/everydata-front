...
})(["display:grid;grid-template-columns:1fr;grid-auto-rows:25px;grid-gap:0px;width:100%;border:none;margin-top:20px;height:95%;overflow-y:scroll;overscroll-behavior:contain;.timeCell{display:flex;align-items:center;color:grey;border:1px solid grey;}"]);
var DUMMY_DATA = [{
  time: 6,
  am: true
}, {
...
//# sourceMappingURL=schedule.js.51d948f7ef2f4115dbfe.hot-update.js.map