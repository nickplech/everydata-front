...
})(["display:flex;grid-row:1;grid-column:1;flex-direction:row;justify-content:center;.hour{background:rgba(10,20,40,1);}.min{background:rgba(10,20,140,1);}"]);
...
})(["border:none;border-radius:5px;display:flex;cursor:pointer;position:relative;width:50px;height:25px;"]);
var hourOptions = [{
  value: '1:00',
  label: '1'
}, {
...
//# sourceMappingURL=client.js.2f2e1f89e04fdedc8a52.hot-update.js.map