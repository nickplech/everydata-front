...
})(["display:grid;grid-template-columns:1fr;grid-auto-rows:30px;grid-gap:1px;width:100%;margin-top:90px;height:90%;overflow-y:scroll;overscroll-behavior:contain;.timeCell{display:flex;padding-left:5px;align-items:center;border-bottom:none;border-top:1px solid grey;border-left:5px solid lightblue;background:rgba(240,240,240,.4) color:grey;}"]);
var DUMMY_DATA = [{
  time: 6,
  am: true
}, {
...
//# sourceMappingURL=schedule.js.8e237318e07fb1762292.hot-update.js.map