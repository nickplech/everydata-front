...
var DateLine = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].div.withConfig({
...
})(["display:grid;grid-column:2;background:rgba(200,200,200,0.1);box-shadow:0 0 5px 3px rgba(0,0,0,0.05);margin:0 auto;border-radius:5px 5px 5px 5px;z-index:-1;padding:10px 30px;height:100%;width:98%;position:absolute;overflow:scroll;overscroll-behavior:contain;ul{list-style:none;padding:0;}"]);
...
})(["padding:10px 10px;display:flex;justify-content:center;align-items:center;max-width:600px;border-radius:5px;margin:10px 0px;min-height:50px;box-shadow:0 0 4px 2px rgba(0,0,0,0.1);cursor:pointer;transition:0.4s;&:hover{background:rgba(10,110,220,0.3);}&:active{box-shadow:none;}h5{font-size:16px;margin:5px;font-weight:400;font-family:'Montserrat',sans-serif;}span{font-weight:700;}.content{overflow:hidden;font-size:18px;border-radius:5px;background:rgba(240,240,240,1);color:black;min-width:330px;width:100%;margin-bottom:0px;}.content-wrapper{padding:20px 10px;}"]);
...
//# sourceMappingURL=inbox.js.e1114b79a26f41cb0b6f.hot-update.js.map