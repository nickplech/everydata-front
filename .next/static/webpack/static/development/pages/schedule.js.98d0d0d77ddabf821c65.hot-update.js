...
})(["background-color:#fff;border-radius:5px;display:grid;grid-row:3;position:relative;align-items:center;margin:0 auto;height:60%;background:rgba(20,100,220,1);color:white;width:120px;font-size:22px;z-index:900;"]);
...
})(["background-color:#fff;border-radius:5px;display:grid;grid-row:3;margin:0 auto;position:relative;align-items:center;width:120px;height:60%;background:rgba(20,100,220,1);color:white;font-size:22px;z-index:900;"]);
...
//# sourceMappingURL=schedule.js.98d0d0d77ddabf821c65.hot-update.js.map