  ...
  function ReviewMessage() {
    ...
    _defineProperty(_assertThisInitialized(_this), "saveTimeMin", function (e) {
      ...
      var finished = function finished() {
        if (_this.state.time.includes(15)) {
          var minutes = '15';

          var built = _this.state.time.replace(minutes, "".concat(value));

          _this.setState({
            time: built
          });
        } else if (_this.state.time.includes(30)) {
          var _minutes = '30';

          var _built = _this.state.time.replace(_minutes, "".concat(value));

          _this.setState({
            time: _built
          });
        } else if (_this.state.time.includes(45)) {
          var _minutes2 = '45';

          var _built2 = _this.state.time.replace(_minutes2, "".concat(value));
          ...
          var _built3 = _this.state.time.replace(_minutes3, "".concat(value));
      ...
      function replaceVariables() {
        var date = this.state.date.length > 7 ? Object(date_fns__WEBPACK_IMPORTED_MODULE_6__["format"])(this.state.date, 'ddd, MMM Do') : '<date>';
        var str = this.props.seededMessage;
        var mapObj = {
          '<date>': "".concat(date),
...
//# sourceMappingURL=client.js.1f49bb548e5c7129ea2b.hot-update.js.map