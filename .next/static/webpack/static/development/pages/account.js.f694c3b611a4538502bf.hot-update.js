...
})(["display:inline-block;padding-right:10px;padding-left:10px;padding-top:5px;transition:all 400ms cubic-bezier(0.4,0,0.2,1) 0ms;margin:", ";box-shadow:0px 0px 3px 1px rgba(0,0,0,0.1);transform:", ";cursor:pointer;background:", ";opacity:1;border-bottom:none;z-index:0;position:relative;&:hover{background:#3d5866;}&:focus{background:rgba(20,110,220,1);}&:nth-child(1){border-radius:10px 0 0 0;}&:nth-child(3){border-radius:0px 10px 0 0;}"], function (props) {
  return props.isActiveTab ? '70px 6px 0 6px' : '70px 0px 0 0px';
}, function (props) {
  return props.isActiveTab ? 'scale(1.1)' : ' scale(1)';
}, function (props) {
  return props.isActiveTab ? 'rgba(20,110,220,.2)' : '#0c344b';
});
...
//# sourceMappingURL=account.js.f694c3b611a4538502bf.hot-update.js.map