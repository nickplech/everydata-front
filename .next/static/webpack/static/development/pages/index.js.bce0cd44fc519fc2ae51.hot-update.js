...
function (_React$Component) {
  ...
  function IconMorph() {
    ...
    _defineProperty(_assertThisInitialized(_this), "gotoNext", function () {
      ...
      var textIndex = _this.state.textIndex;
      var nextText = textIndex + 1;

      _this.setState({
        pathIndex: nextIndex > pathIds.length - 1 ? 0 : nextIndex,
        buttonText: nextText > text.length - 1 ? 0 : nextText
      });
    });
...
//# sourceMappingURL=index.js.bce0cd44fc519fc2ae51.hot-update.js.map