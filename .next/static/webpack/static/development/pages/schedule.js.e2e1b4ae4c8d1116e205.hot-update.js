...
})(["display:grid;grid-template-columns:1fr 1fr 1fr;grid-auto-rows:20px;grid-gap:1px;width:450px;border-bottom:2px solid grey;border-right:2px solid lightblue;margin-top:90px;height:80vh;overflow-y:scroll;overscroll-behavior:contain;.timeCell{display:grid;grid-column:1/4;padding-left:5px;align-items:center;border-bottom:none;border-top:1px solid white;border-left:5px solid lightblue;background:rgba(100,100,240,0.2);color:grey;&:hover{background:blue;opacity:0.2;}}.lower{display:grid;grid-column:1/4;padding-left:5px;align-items:center;border-bottom:none;border-top:1px solid white;border-left:5px solid lightblue;background:rgba(243,241,244,1);color:grey;&:hover{background:blue;opacity:0.1;}}"]);
var DUMMY_DATA = [{
  time: 8,
  am: true,
  q2: 815,
...
var SingleDay = function SingleDay(props) {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(DayView, {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(HourCell, {
      key: index,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 218
...
//# sourceMappingURL=schedule.js.e2e1b4ae4c8d1116e205.hot-update.js.map