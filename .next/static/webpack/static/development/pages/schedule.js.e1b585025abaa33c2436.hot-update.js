...
function (_React$Component) {
  ...
  function CalendarStats() {
    ...
    _defineProperty(_assertThisInitialized(_this), "state", {
      date: date_fns__WEBPACK_IMPORTED_MODULE_1__["dateFns"].startOfDay(new Date()) // today: dateFns.startOfDay(new Date()),
    ...
    _defineProperty(_assertThisInitialized(_this), "handleToday", function (date) {
      return _this.setState({
        date: date_fns__WEBPACK_IMPORTED_MODULE_1__["dateFns"].startOfDay(new Date())
      });
    });
...
//# sourceMappingURL=schedule.js.e1b585025abaa33c2436.hot-update.js.map