...
})(["grid-column:2;grid-row:2;position:relative;z-index:6;width:80%;padding:10px;height:100%;max-height:150px;border-radius:10px;font-size:2rem;resize:none;border:none;background:rgba(250,250,250,1);box-shadow:0 0 4px 3px rgba(0,0,0,0.05);&:focus{outline:none;}"]);
...
//# sourceMappingURL=client.js.25c07d73cd5e00da88b2.hot-update.js.map