...
})(["display:grid;grid-template-columns:300px 1fr;grid-template-rows:1fr;height:calc(100vh - 100px);width:99%;position:absolute;padding-left:10px;padding-right:10px;right:10px;margin:0 auto;top:85px;grid-column-gap:8px;grid-row-gap:8px;bottom:0;z-index:-1;"]);
...
})(["display:grid;grid-column:2;background:rgba(200,200,200,0.1);box-shadow:0 0 5px 3px rgba(0,0,0,0.05);margin:0 auto;border-radius:5px 5px 5px 5px;z-index:-1;padding:10px 10px;height:100%;width:100%;position:absolute;overflow:scroll;overscroll-behavior:contain;ul{list-style:none;padding:0;}"]);
...
//# sourceMappingURL=inbox.js.efb4c24c740e9ec24714.hot-update.js.map