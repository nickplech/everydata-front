...
})(["padding:3px 10px;margin:4px 5px;border-width:2px;border-style:solid;background:transparent;color:white;min-width:50px;text-align:center;cursorborder-radius:25px;list-style:none;transition:0.2s;&:hover{transform:scale(1.1);box-shadow:1px 1px 4px 3px rgba(0,0,0,0.1);}"]);
...
//# sourceMappingURL=account.js.055de02c0cbbecc026fb.hot-update.js.map