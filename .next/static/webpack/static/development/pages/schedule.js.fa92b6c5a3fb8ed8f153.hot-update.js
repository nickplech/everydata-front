...
})(["padding:3px 10px;margin:4px 6px;border-width:2px;border-style:solid;background:transparent;color:white;background:rgba(20,110,240,1);color:white;border-color:white;min-width:50px;text-align:center;cursor:pointer;border-radius:25px;list-style:none;transition:0.2s;&:hover{box-shadow:1px 1px 4px 3px rgba(0,0,0,0.1);}&:first-child{margin-top:40px;}"]);
...
//# sourceMappingURL=schedule.js.fa92b6c5a3fb8ed8f153.hot-update.js.map