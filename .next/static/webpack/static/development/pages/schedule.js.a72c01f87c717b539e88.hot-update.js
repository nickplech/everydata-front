...
})(["display:grid;grid-template-columns:1fr;grid-auto-rows:30px;border-radius:20px;grid-gap:1px;width:50%;border-bottom:2px solid grey;margin-left:15px;margin-top:90px;height:70vh;overflow-y:scroll;overscroll-behavior:contain;.timeCell{display:flex;margin-top:2px;padding-left:5px;align-items:center;border-bottom:none;border-top:1px solid white;border-right:2px solid white;border-left:5px solid lightblue;background:rgba(100,100,240,0.2);color:grey;&:hover{background:blue;opacity:0.2;}}.lower{display:flex;padding-left:5px;align-items:center;border-bottom:none;border-top:1px solid white;border-left:5px solid lightblue;border-right:2px solid white;background:rgba(243,241,244,1);color:grey;&:hover{background:blue;opacity:0.1;}}"]);
var DUMMY_DATA = [{
  time: 8,
  am: true,
  q2: 815,
...
//# sourceMappingURL=schedule.js.a72c01f87c717b539e88.hot-update.js.map