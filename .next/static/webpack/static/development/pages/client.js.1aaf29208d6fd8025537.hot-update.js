...
function (_Component) {
  ...
  function SingleClient(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "scrollToBottom", function (ref) {
      if (!ref) {
        null;
      }

      return _this.myRef.current.scrollIntoView();
    });
...
//# sourceMappingURL=client.js.1aaf29208d6fd8025537.hot-update.js.map