...
})(["position:relative;display:grid;grid-row:1/3;grid-column:2/3;width:100%;height:100%;background-color:transparent;box-shadow:0 0 5px 3px rgba(0,0,0,0.05);border:5px solid white;border-radius:25px;z-index:-1;.parent{display:block;text-align:center;}.date{display:inline-block;text-transform:uppercase;margin-bottom:0;color:rgba(100,120,220,1);}.sideDate{display:inline-block;text-align:right;margin-top:0;}"]);
...
//# sourceMappingURL=schedule.js.4187150b6372d3637cf6.hot-update.js.map