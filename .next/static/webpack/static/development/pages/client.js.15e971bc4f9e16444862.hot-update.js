...
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n  query ALL_CLIENTS_REMINDERS($clientId: ID!) {\n    textReminders(clientId: $clientId, orderBy: createdAt_DESC) {\n      id\n      text\n      user {\n        id\n      }\n      client {\n        id\n      }\n    }\n  }\n"]);
...
})(["display:grid;grid-column:2;grid-row:1;background-color:transparent;box-shadow:0 0 5px 3px rgba(0,0,0,0.05);border:5px solid white;border-radius:25px;z-index:-1;height:100%;width:100%;overflow:scroll;"]);
var StyledTitle = styled_components__WEBPACK_IMPORTED_MODULE_4__["default"].h2.withConfig({
...
})(["margin-top:1px;opacity:0.2;border:1px solid grey;"]); // const Lister = styled.div`
//   position: relative;
//   display: flex;
//   flex-flow: column;
//   /* padding-bottom: 20px; */
...
//# sourceMappingURL=client.js.15e971bc4f9e16444862.hot-update.js.map