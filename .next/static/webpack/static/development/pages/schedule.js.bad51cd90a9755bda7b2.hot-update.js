...
})(["width:100%;border:2px solid rgba(20,110,220,.8);background:transparent;margin:5px 0 20px 0;height:50px;font-size:2rem;font-weight:500;color:rgba(0,0,0,.5);outline:none;position:relative;z-index:990;option{background:white;padding:1rem;transition:all 0.2s;padding-left:2rem;display:flex;align-items:center;}"]);
...
//# sourceMappingURL=schedule.js.bad51cd90a9755bda7b2.hot-update.js.map