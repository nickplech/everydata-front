...
/*!*************************************!*\
  !*** ./components/ReviewMessage.js ***!
  \*************************************/
/*! exports provided: default, TEXT_TEMPLATES_QUERY, SEND_TEXT_MUTATION, FIRE_FLASH_MUTATION, LOCAL_FLASH_QUERY */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FIRE_FLASH_MUTATION", function() { return FIRE_FLASH_MUTATION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LOCAL_FLASH_QUERY", function() { return LOCAL_FLASH_QUERY; });
...
var LOCAL_FLASH_QUERY = graphql_tag__WEBPACK_IMPORTED_MODULE_3___default()(_templateObject());
var FIRE_FLASH_MUTATION = graphql_tag__WEBPACK_IMPORTED_MODULE_3___default()(_templateObject2());
var SEND_TEXT_MUTATION = graphql_tag__WEBPACK_IMPORTED_MODULE_3___default()(_templateObject3());
var TEXT_TEMPLATES_QUERY = graphql_tag__WEBPACK_IMPORTED_MODULE_3___default()(_templateObject4());
...
})(["display:block;position:absolute;min-width:300px;width:30%;transform:translateX(100%);text-align:center;padding:10px;background:rgba(20,180,110,0.9);color:white;border-radius:5px;bottom:15px;box-shadow:0 16px 24px 2px rgba(0,0,0,0.1),0 6px 10px 5px rgba(0,0,0,0.1),0 8px 10px -5px rgba(0,0,0,0.2);right:20px;", ";z-index:999;"], function (props) {
        ...
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_4__["Query"], {
          ...
          return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_4__["Mutation"], {
            ...
            return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Back, {
              ...
              __self: this
            }, "Appointment Reminder Failed to Send. Please Try Again Shortly"), !error && !loading && called && react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Submitted, {
              open: flashOpen,
              __source: {
                fileName: _jsxFileName,
                lineNumber: 215
...
//# sourceMappingURL=client.js.4c02020e421d445ae284.hot-update.js.map