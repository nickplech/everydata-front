...
})(["height:20vh;margin:100px 0;padding:0;justify-content:stretch;align-items:center;display:flex;background-image:linear-gradient(-180deg,#ffe400 0%,#ff6a25 100%);#root{color:#fff;font-size:32px;font-family:PT Sans,'Segoe UI',Tahoma,Geneva,Verdana,sans-serif;font-weight:200;text-shadow:2px 2px 0px rgba(0,0,0,0.2);width:100%;align-items:center;justify-content:center;flex-direction:column;display:flex;}button{border:none;margin:0;width:auto;overflow:visible;background:transparent;-webkit-font-smoothing:inherit;-moz-osx-font-smoothing:inherit;-webkit-appearance:none;background:#000;font-size:22px;color:white;padding:15px 20px;margin-top:30px;cursor:pointer;}"]);
var paths = {
  ...
  circle: 'M255,0C114.75,0,0,114.75,0,255s114.75,255,255,255s255-114.75,255-255S395.25,0,255,0z',
  ...
  _createClass(IconMorph, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(StyledBody, {
        ...
        __self: this
      }, "Next icon!"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("svg", {
        width: "400",
        height: "400",
        viewBox: "0 0 520 500",
        __source: {
...
//# sourceMappingURL=index.js.1bc52de7f6cfbaf6bbe9.hot-update.js.map