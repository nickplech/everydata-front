...
})(["grid-column:2;grid-row:2;position:relative;z-index:6;margin:0 10px;width:80%;padding:10px;height:100%;max-height:140px;border-radius:10px;font-size:1.5rem;resize:none;border:none;background:rgba(250,250,250,1);box-shadow:0 0 4px 3px rgba(0,0,0,0.05);&:focus{outline:none;}&:after{display:block;font-size:11px;bottom:160px;right:40px;position:absolute;z-index:10px;}"]);
...
//# sourceMappingURL=client.js.928c2deed9aec0adc37e.hot-update.js.map