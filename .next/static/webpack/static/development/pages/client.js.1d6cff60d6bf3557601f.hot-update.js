  ...
  function ReviewMessage() {
    ...
    _defineProperty(_assertThisInitialized(_this), "saveTime", function (e) {
      ...
      if (name === 'date') {
        ...
        var textTemplate = _this.props.seededMessage.replace('<date>', _date);
      ...
      if (name === 'time') {
        ...
        var _textTemplate = _this.props.seededMessage.replace('<date>', date, '<time>', time);
...
//# sourceMappingURL=client.js.1d6cff60d6bf3557601f.hot-update.js.map