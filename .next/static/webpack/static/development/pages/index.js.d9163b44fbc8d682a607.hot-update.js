...
})(["display:inline-block;background:transparent;border:2px solid white;margin-left:20%;padding:8px 12px;margin-top:15px;color:white;border-radius:5px;font-size:18px;cursor:pointer;&:hover{transition:0.4s;transform:scale(1.1);color:white;}&:focus{transform:scale(1);}"]);
...
//# sourceMappingURL=index.js.d9163b44fbc8d682a607.hot-update.js.map