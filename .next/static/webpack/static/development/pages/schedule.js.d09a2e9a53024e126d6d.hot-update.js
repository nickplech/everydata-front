...
})(["background-color:#fff;border-radius:25px;flex-flow:column;display:grid;grid-template-rows:50px 1fr 80px;position:absolute;align-items:center;width:500px;min-height:300px;padding:10px 25px;z-index:900;"]);
...
})(["background-color:#fff;border-radius:5px;display:grid;grid-row:3;position:relative;align-items:center;margin:0 auto;height:60%;background:rgba(220,100,220,1);color:white;width:120px;font-size:22px;z-index:900;"]);
...
})(["background-color:#fff;border-radius:5px;display:grid;grid-row:3;margin:0 auto;position:relative;align-items:center;width:120px;height:60%;background:rgba(20,200,120,1);color:white;font-size:22px;z-index:900;"]);
...
//# sourceMappingURL=schedule.js.d09a2e9a53024e126d6d.hot-update.js.map