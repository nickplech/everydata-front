...
})(["background:rgba(30,110,240,1);color:white;font-weight:800;border:0;width:90%;display:grid;grid-column:2;font-size:2rem;justify-self:center;padding:0.4rem 1.2rem;font-size:1.8rem;border-radius:5px;outline:none;cursor:pointer;box-shadow:1px 1px 2px 1px rgba(0,0,0,0.15);&:active{box-shadow:none;}&[disabled]{opacity:0.5;}&:hover{background:rgba(30,110,240,0.9);}"]);
...
//# sourceMappingURL=client.js.916a07b6a874a2b12da1.hot-update.js.map