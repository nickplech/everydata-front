...
})(["display:flex;grid-row:1;grid-column:1;flex-direction:row;.hour{background:rgba(10,20,40,1);}.min{background:rgba(10,20,140,1);}"]);
...
})(["border:none;border-radius:5px;justify-content:center;display:flex;cursor:pointer;position:relative;width:50px;height:25px;"]);
var hourOptions = [{
  value: '1:00',
  label: '1'
}, {
...
//# sourceMappingURL=client.js.394c93f6ec2b4982b43a.hot-update.js.map