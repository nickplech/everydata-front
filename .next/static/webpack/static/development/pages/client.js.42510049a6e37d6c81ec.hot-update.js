...
})(["position:relative;display:flex;padding-bottom:20px;box-sizing:border-box;padding-left:6px;width:100%;height:100%;overflow-y:auto;background:white;.message{display:flex;align-content:center;margin:0px 30px;padding:0px;border-bottom:1.5px solid rgba(220,220,220,0.4);}.message-text{align-self:center;background:rgba(220,220,220,0.8);font-family:'Montserrat',sans-serif;color:black;display:block;font-size:12px;padding:10px 14px;margin:12px 0;border-radius:8px;width:50%;height:80%;max-width:600px;min-width:300px;}"]);
var DUMMY_DATA = [{
  senderId: 'perborgen',
...
//# sourceMappingURL=client.js.42510049a6e37d6c81ec.hot-update.js.map