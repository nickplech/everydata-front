...
})(["grid-column:2;grid-row:2;position:relative;z-index:6;width:100%;padding:10px;height:100%;border-radius:10px;resize:none;border:none;box-shadow:0 0 4px 3px rgba(0,0,0,0.05);&:focus{outline:none;}p{font-size:26px;}"]);
...
var ReviewMessage = function ReviewMessage() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Back, {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_DaySelector__WEBPACK_IMPORTED_MODULE_4__["default"], {
      ...
      readOnly: true,
      max: 160,
      value: data.textTemplates[0].content,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 100
      },
...
//# sourceMappingURL=client.js.3e91ca4938f404474944.hot-update.js.map