...
})(["position:relative;display:flex;flex-flow:column;padding-bottom:20px;box-sizing:border-box;padding-left:6px;width:100%;height:calc(100% - 50px);overflow-y:auto;background:white;.message{display:flex;align-content:center;margin:0px 30px;padding:0px;border-bottom:1.5px solid rgba(220,220,220,0.4);}.message-text{align-self:center;background:rgba(220,220,220,0.8);font-family:'Montserrat',sans-serif;color:black;display:block;font-size:12px;padding:10px 14px;margin:12px 0;border-radius:8px;width:50%;height:80%;max-width:600px;min-width:300px;}"]);
var DUMMY_DATA = [{
  senderId: 'perborgen',
...
//# sourceMappingURL=client.js.0f864f9c696ad6f0e747.hot-update.js.map