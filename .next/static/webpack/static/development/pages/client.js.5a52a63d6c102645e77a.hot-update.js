...
})(["grid-column:2;grid-row:2;position:relative;z-index:6;margin:0 10px;width:80%;padding:10px;height:100%;line-height:22px;max-height:140px;border-radius:10px;font-size:1.5rem;resize:none;border:none;background:rgba(250,250,250,1);box-shadow:0 0 4px 3px rgba(0,0,0,0.05);&:focus{outline:none;}"]);
...
var PG = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].p.withConfig({
  displayName: "ReviewMessage__PG",
  componentId: "sc-1kkiazb-5"
})(["font-size:10px;margin:0;color:rgba(10,150,10,0.6);"]);
var PR = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].p.withConfig({
  displayName: "ReviewMessage__PR",
  componentId: "sc-1kkiazb-6"
...
function (_Component) {
  ...
  function ReviewMessage() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleText", function (e) {
      _this.setState({
        text: e.target.value
      });
    });
        ...
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_4__["Query"], {
          ...
          return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_4__["Mutation"], {
            ...
            return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Back, {
              ...
              __self: this
            }, defaultTemplate.length < 160 && react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(PG, {
              __source: {
                fileName: _jsxFileName,
                lineNumber: 234
              },
...
//# sourceMappingURL=client.js.5a52a63d6c102645e77a.hot-update.js.map