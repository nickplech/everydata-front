...
})(["border:none;border-radius:50%;align-items:center;outline:none;text-align:center;color:white;display:flex;cursor:pointer;position:relative;width:25px;height:25px;margin:0px 2px -5px 2px;&:hover{transform:scale(1.1);}&:disabled{opacity:0.4;}"]);
var hourOptions = [{
  value: '1:00',
  label: '1'
}, {
...
//# sourceMappingURL=client.js.98077c8f51392a540093.hot-update.js.map