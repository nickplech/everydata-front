...
})(["align-self:center;grid-column:1/3;grid-row:1;justify-content:center;border-radius:25px 25px 0 0;overflow:hidden;height:100%;padding:5px 20px 0px 20px;border:2px solid ", ";border-radius:5px;font-family:'Montserrat',sans-serif;color:", ";display:block;text-align:center;padding:0px 0px;font-size:2.2rem;p{margin:0;font-size:18px;position:relative;}h3{margin:0;}"], function (props) {
...
//# sourceMappingURL=schedule.js.0bcc84319b6d118530c6.hot-update.js.map