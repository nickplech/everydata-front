...
})(["background-color:#fff;border-radius:25px;flex-flow:column;display:grid;grid-template-rows:50px 1fr 80px;position:absolute;align-items:center;width:500px;min-height:300px;z-index:900;"]);
...
})(["background-color:#fff;border-radius:5px;display:grid;grid-row:3;position:relative;align-items:center;padding:0 15px;height:80%;background:rgba(20,100,220,1);color:white;z-index:900;"]);
...
})(["background-color:#fff;border-radius:5px;display:grid;grid-row:3;position:relative;align-items:center;padding:0 15px;height:80%;background:rgba(20,100,220,1);color:white;font-size:22px;z-index:900;"]);
...
//# sourceMappingURL=schedule.js.328317272e8175b94981.hot-update.js.map