...
/* harmony import */ var _Slider__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./Slider */ "./components/Slider.js");
...
var ADD_TO_CART_MUTATION = graphql_tag__WEBPACK_IMPORTED_MODULE_3___default()(_templateObject2());
var TEXT_TEMPLATES_QUERY = graphql_tag__WEBPACK_IMPORTED_MODULE_3___default()(_templateObject3());
...
function (_Component) {
  ...
  function ReviewMessage() {
    ...
    _defineProperty(_assertThisInitialized(_this), "addingCart",
    /*#__PURE__*/
    function () {
      var _ref4 = _asyncToGenerator(
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(e, client, createTextReminder) {
        var res, result;
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return createTextReminder({
                  variables: {
                    to: _this.props.cellPhone.toString(),
                    text: _this.state.text,
                    client: _this.props.client,
                    user: _this.props.user,
                    confirmationStatus: 'UNCONFIRMED',
                    forDate: _this.state.date
                  }
                });
              ...
              case 3:
                res = _context.sent;
                _context.next = 6;
                return _this.addingCart();

              case 6:
                _context.next = 8;
                return client.mutation({
                  mutation: ADD_TO_CART_MUTATION,
                  refetchQueries: _Slider__WEBPACK_IMPORTED_MODULE_12__["ALL_CARTITEMS_QUERY"],
                  awaitRefetchQueries: true,
                  variables: {
                    id: _this.props.client,
                    confirmationStatus: 'UNCONFIRMED',
                    textReminder: res.data.createTextReminder.id
                  }
                });
  ...
  _createClass(ReviewMessage, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_4__["ApolloConsumer"], {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 257
        },
        ...
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_4__["Mutation"], {
          mutation: SEND_TEXT_MUTATION,
          variables: {
            to: _this2.props.cellPhone.toString(),
            text: _this2.state.text,
            client: _this2.props.client,
            user: _this2.props.user,
            confirmationStatus: 'UNCONFIRMED',
            forDate: _this2.state.date
          },
          refetchQueries: [{
          ...
          __self: this
        }, function (createTextReminder, _ref5) {
          ...
          return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Form, {
            onSubmit: function onSubmit(e) {
              _this2.addingCart(e, client, createTextReminder);
            },
            __source: {
              fileName: _jsxFileName,
              lineNumber: 281
...
//# sourceMappingURL=client.js.c45e6cc0d8d2d28abcf7.hot-update.js.map