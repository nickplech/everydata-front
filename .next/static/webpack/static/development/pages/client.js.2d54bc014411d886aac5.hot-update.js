...
var DaySelector = function DaySelector(props) {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(DateSelector, {
    ...
    __self: this
  }, props.result.map(function (day, i) {
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Days, {
      key: day,
      readOnly: true,
      onClick: props.handleDate,
      value: Object(date_fns__WEBPACK_IMPORTED_MODULE_3__["format"])(day, 'DDD, MMM Do'),
      __source: {
        fileName: _jsxFileName,
        lineNumber: 92
      },
...
//# sourceMappingURL=client.js.2d54bc014411d886aac5.hot-update.js.map