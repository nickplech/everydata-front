...
})(["display:inline-flex;align-content:center;align-items:center;justify-content:center;width:30px;height:30px;background:white;border:2px solid white;border-radius:50%;margin-right:40px;.plus{display:inline-flex;text-align:center;color:purple;font-size:25px;}"]);
var data = [{
...
//# sourceMappingURL=hipaa.js.016d0e6e8acd0c31aa27.hot-update.js.map