...
})(["background:rgba(20,110,240,1);border-radius:50%;display:flex;align-items:center;justify-content:center;height:25px;width:25px;padding-bottom:6px;border:1px solid green;position:relative;z-index:20;cursor:pointer;opacity:0.6;outline:none;&:hover{transform:scale(1.1);}.child{position:absolute;justify-self:center;display:flex;font-family:'Montserrat',sans-serif;color:white;font-size:3rem;padding-left:0px;}"]);
...
//# sourceMappingURL=account.js.43992518db517743e32e.hot-update.js.map