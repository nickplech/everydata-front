...
})(["display:flex;margin:2px;width:12.25%;height:40%;font-size:10px;color:white;grid-row:3;background:#3d5866;align-content:center;text-align:center;outline:none;font-family:'Montserrat',sans-serif;transition:0.2s;border:none;box-shadow:0 0 5px 3px rgba(0,0,0,0.1);cursor:pointer;&:focus{background:rgba(20,110,240,0.8);}&:hover{transform:scale(1.1);}&:active{background:rgba(20,110,240,0.8);}"]);
...
//# sourceMappingURL=client.js.3a7f8c39227e895b965a.hot-update.js.map