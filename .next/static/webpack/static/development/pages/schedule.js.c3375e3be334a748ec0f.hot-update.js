...
})(["position:relative;display:grid;grid-row:1/3;grid-column:2/3;width:100%;height:100%;background-color:transparent;box-shadow:0 0 5px 3px rgba(0,0,0,0.05);border:5px solid white;border-radius:25px;z-index:-1;.parent{display:block;text-align:center;}.date{display:inline-block;text-transform:uppercase;margin-bottom:0;color:rgba(100,120,220,1);font-size:34px;}.sideDate{display:inline-block;position:absolute;right:20px;margin:0;font-family:'Montserrat',sans-serif;font-size:26px;}"]);
...
var SingleDay = function SingleDay(props) {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(DayView, {
    ...
    __self: this
  }, moment__WEBPACK_IMPORTED_MODULE_2___default()(props.date.toString()).format('MMMM D, YYYY')), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("hr", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 57
    },
...
//# sourceMappingURL=schedule.js.c3375e3be334a748ec0f.hot-update.js.map