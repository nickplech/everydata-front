...
})(["background-color:#fff;border-radius:5px;display:grid;grid-row:3;grid-column:2;position:relative;align-items:center;justify-self:flex-end;height:40%;background:rgba(220,100,120,1);color:white;width:120px;font-size:18px;z-index:900;&:focus{outline:none;}"]);
...
})(["background-color:#fff;border-radius:5px;display:grid;grid-column:2;grid-row:3;margin:0 auto;position:relative;align-items:center;width:120px;height:40%;background:rgba(20,200,120,1);color:white;font-size:18px;z-index:900;&:focus{outline:none;}"]);
...
//# sourceMappingURL=signup.js.46208f7a58736db0985f.hot-update.js.map