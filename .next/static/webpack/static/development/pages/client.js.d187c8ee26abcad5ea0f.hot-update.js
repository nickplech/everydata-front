...
})(["border:none;border-radius:5px 5px 0 0;display:flex;outline:none;text-align:center;color:white;cursor:pointer;position:relative;width:30px;height:30px;margin:0px 2px -5px 2px;&:hover{transform:scale(1.1);}&:disabled{opacity:0.4;}"]);
var hourOptions = [{
  value: '1:00',
  label: '1'
}, {
...
//# sourceMappingURL=client.js.d187c8ee26abcad5ea0f.hot-update.js.map