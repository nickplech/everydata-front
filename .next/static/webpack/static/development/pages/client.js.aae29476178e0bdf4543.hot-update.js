...
})(["display:flex;flex-flow:column;.gear{position:absolute;height:25px;width:25px;left:215px;margin-top:10px;}.center{font-family:'Open Sans',Helvetica,sans-serif;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;position:relative;height:299px;width:250px;background:#fff;border-radius:18px;overflow:hidden;box-shadow:2px 2px 3px 0 rgba(0,0,0,0.2);}.profile{width:100%;height:300px;text-align:center;}.image{position:relative;width:100px;height:100px;margin:30px auto 0 auto;}img{display:block;border-radius:50%;background:#f5e8df;}.image:hover{cursor:pointer;}.stats{display:flex;flex-flow:row nowrap;margin-top:35px;height:100px;color:white;justify-content:center;align-content:center;align-items:center;background:rgba(30,110,240,1);text-align:center;}"]);
...
//# sourceMappingURL=client.js.aae29476178e0bdf4543.hot-update.js.map