...
function (_Component) {
  ...
  function ReviewMessage() {
    ...
    _defineProperty(_assertThisInitialized(_this), "updateText", function (e) {
      _this.state.text.replace('<time>', time).replace('<date>', date);
    });
...
//# sourceMappingURL=client.js.f3491c561fb2c8486838.hot-update.js.map