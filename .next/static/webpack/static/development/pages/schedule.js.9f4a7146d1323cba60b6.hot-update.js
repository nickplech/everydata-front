...
})(["display:grid;grid-template-columns:1fr;grid-auto-rows:25px;grid-gap:1px;width:40%;border-bottom:2px solid lightblue;border-right:3px solid lightblue;margin-top:90px;height:75vh;overflow-y:scroll;overscroll-behavior:contain;.timeCell{display:flex;padding-left:5px;align-items:center;border-bottom:none;border-top:1px solid grey;border-left:5px solid lightblue;background:rgba(100,100,240,0.2);color:grey;&:hover{background:red;opacity:0.2;}}.lower{display:flex;padding-left:5px;align-items:center;border-bottom:none;border-top:1px solid rgba(0,0,0,0.3);border-left:5px solid lightblue;background:white;color:grey;&:hover{background:red;opacity:0.1;}}"]);
var DUMMY_DATA = [{
  time: 8,
  am: true,
  q2: 815,
...
//# sourceMappingURL=schedule.js.9f4a7146d1323cba60b6.hot-update.js.map