...
})(["display:inline-block;background:transparent;border:2px solid white;margin-left:20%;padding:8px 12px;margin-top:15px;color:white;border-radius:5px;font-size:18px;cursor:pointer;&:hover{transition:0.2s;transform:scale(1.1);color:white;}&:active{transform:scale(1);}"]);
...
//# sourceMappingURL=index.js.49f8369a57b777b8dc76.hot-update.js.map