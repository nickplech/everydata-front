...
})(["display:inline-block;padding-right:10px;padding-left:10px;padding-top:5px;transition:all 300ms cubic-bezier(0.4,0,0.2,1) 0ms;margin:26px 0px 0 0px;cursor:pointer;border:1px solid grey;opacity:0.4;border-bottom:none;&:hover{opacity:1;}&:nth-child(1){border-radius:10px 0 0 0;}&:nth-child(3){border-radius:0px 10px 0 0;}"]);
...
//# sourceMappingURL=account.js.76efa80a73825d03b5d3.hot-update.js.map