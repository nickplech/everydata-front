...
})(["display:inline-flex;align-content:center;align-items:center;justify-content:center;width:30px;height:30px;background:white;border:2px solid rgba(20,110,220,1);border-radius:50%;margin-right:40px;.plus{display:inline-flex;text-align:center;font-weight:100;-webkit-touch-callout:none;-webkit-user-select:none;-khtml-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;color:rgba(20,110,220,1);font-size:25px;margin-bottom:2px;margin-right:0px;}"]);
...
//# sourceMappingURL=pricing.js.06a8bd3ccd7da80774a7.hot-update.js.map