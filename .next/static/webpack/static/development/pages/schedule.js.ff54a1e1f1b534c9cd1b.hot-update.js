...
})(["background:rgba(30,110,240,1);color:white;font-weight:800;border:0;margin:20px 0;display:flex;justify-self:flex-end;border-radius:5px;font-size:2rem;padding:0.5rem 1.2rem;font-size:2rem;transition:all 0.5s;outline:none;cursor:pointer;box-shadow:1px 1px 4px 2px rgba(0,0,0,0.2);&[disabled]{opacity:0.5;}&:hover{background:rgba(30,110,240,0.9);transform:scale(1.1);}&:active{box-shadow:none;}"]);
...
//# sourceMappingURL=schedule.js.ff54a1e1f1b534c9cd1b.hot-update.js.map