...
})(["display:flex;margin:2px;width:12.25%;height:40%;color:white;grid-row:3;background:#3d5866;align-content:center;text-align:center;outline:none;border:none;box-shadow:0 0 5px 3px rgba(0,0,0,0.1);cursor:pointer;&:first-child{background:red;}&:hover{opacity:0.7;}&:active{background:lavender;}"]);
...
//# sourceMappingURL=client.js.2456bb4ca601b61dcbd3.hot-update.js.map