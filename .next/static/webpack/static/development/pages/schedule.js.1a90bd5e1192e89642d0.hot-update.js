...
var Input = styled_components__WEBPACK_IMPORTED_MODULE_5__["default"].input.withConfig({
  displayName: "ClientSearch__Input",
  componentId: "sc-176btmj-0"
})(["border:2px solid rgba(20,110,240,1);width:100%;height:100%;padding:10px;border:0;font-size:2rem;outline:none;&.loading{animation:", " 0.5s ease-in-out infinite alternate;}"], glow);
...
})(["border-radius:50%;width:40px;height:40px;"]); // function routeToClient(client) {
//   Router.push({
//     pathname: '/client',
//     query: {
//       id: client.id,
...
function (_Component) {
  ...
  _createClass(ClientSearch, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(downshift__WEBPACK_IMPORTED_MODULE_2__["default"] // onChange={routeToClient}
      , {
...
//# sourceMappingURL=schedule.js.1a90bd5e1192e89642d0.hot-update.js.map