...
var Inner = styled_components__WEBPACK_IMPORTED_MODULE_7__["default"].div.withConfig({
  ...
  componentId: "h45ly-0"
})(["max-width:", ";margin:0 auto;padding:2rem;.dates{font-family:montserrat,sans-serif;text-transform:uppercase;opacity:0.5;&:focus{opacity:1;}&:active{opacity:1;}}.create-contact-avatar-input{min-width:80px;height:80px;background-color:lightgrey;background-image:url('../static/person.svg');background-size:32px 32px;background-position:center;background-repeat:no-repeat;border-radius:50%;cursor:pointer;}"], function (props) {
...
//# sourceMappingURL=addclient.js.c828a0a5071c1858dbeb.hot-update.js.map