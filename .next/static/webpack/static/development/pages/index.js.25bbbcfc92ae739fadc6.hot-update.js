...
})(["display:flex;padding:10px 0px;align-items:center;justify-content:center;margin:0 auto;margin-top:75px;margin-bottom:75px;background:white;color:gray;border:none;border-radius:25px;width:200px;text-transform:uppercase;font-size:14px;box-shadow:3px 3px 3px 3px rgba(0,0,0,0.2);"]);
...
//# sourceMappingURL=index.js.25bbbcfc92ae739fadc6.hot-update.js.map