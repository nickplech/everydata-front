...
})(["display:flex;padding:20px 0px;align-items:center;justify-content:center;margin:0 auto;margin-top:75px;margin-bottom:75px;background:white;color:gray;border:none;border-radius:25px;width:250px;text-transform:uppercase;font-size:14px;box-shadow:2px 3px 2px 2px rgba(0,0,0,0.2);"]);
...
//# sourceMappingURL=index.js.294554ee6f7fd82c0e95.hot-update.js.map