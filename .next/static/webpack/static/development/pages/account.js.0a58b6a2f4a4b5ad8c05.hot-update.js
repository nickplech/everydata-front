...
})(["font-size:1.8rem;background:none;border:none;color:white;margin:0 4px 0 10px;&:hover{color:", ";cursor:pointer;}"], function (props) {
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_1__["Mutation"], {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(BigButton, {
          style: {
            color: _this2.props.color === '#F8F8FF' && 'black'
          },
          disabled: loading,
          onClick: function onClick() {
            if (confirm("WARNING: By deleting the ".concat(_this2.props.name, " appointment type, all existing appointments made with this type will revert to Appointment Type: Standard. Are you sure you want to delete ").concat(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("b", {
              __source: {
                fileName: _jsxFileName,
                lineNumber: 68
              },
...
//# sourceMappingURL=account.js.0a58b6a2f4a4b5ad8c05.hot-update.js.map