...
})(["display:flex;padding:10px 0px;align-items:center;justify-content:center;margin:0 auto;margin-top:65px;margin-bottom:65px;background:white;color:gray;border:none;border-radius:25px;width:250px;text-transform:uppercase;font-size:14px;box-shadow:2px 3px 2px 2px rgba(0,0,0,0.2);"]);
...
//# sourceMappingURL=index.js.4c368ef51be6814fcf30.hot-update.js.map