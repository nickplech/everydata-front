...
function (_Component) {
  ...
  _createClass(ReviewMessage, [{
    ...
    value: function render() {
      ...
      var twoWeeks = Object(date_fns__WEBPACK_IMPORTED_MODULE_6__["addWeeks"])(date, 2);
      var result = Object(date_fns__WEBPACK_IMPORTED_MODULE_6__["eachDay"])(date, twoWeeks);
      var fixedArray = result.splice(-1, 1);
      var oneWeek = Object(date_fns__WEBPACK_IMPORTED_MODULE_6__["addWeeks"])(date, 1);
      var dayNameResult = Object(date_fns__WEBPACK_IMPORTED_MODULE_6__["eachDay"])(date, oneWeek);
      var fixedOneWeek = dayNameResult.splice(-1, 1);
      var time = this.state.time; // const dateDouble =  format(this.state.date, 'ddd, MMM Do')
...
//# sourceMappingURL=client.js.5b3e2f0f616b59951169.hot-update.js.map