...
})(["display:inline-block;padding-right:10px;padding-left:10px;padding-top:5px;transition:all 300ms cubic-bezier(0.4,0,0.2,1) 0ms;margin:50px 1px 0 1px;cursor:pointer;background:", ";opacity:1;border-bottom:none;&:hover{background:rgba(100,210,220,1);}&:focus{background:rgba(20,110,220,1);}&:nth-child(1){border-radius:10px 0 0 0;}&:nth-child(3){border-radius:0px 10px 0 0;}"], function (props) {
...
//# sourceMappingURL=account.js.8cfda341b4a59b501149.hot-update.js.map