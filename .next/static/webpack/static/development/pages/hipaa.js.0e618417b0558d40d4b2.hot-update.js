...
})(["display:inline-flex;align-content:center;align-items:center;justify-content:center;width:30px;height:30px;background:white;border:2px solid white;border-radius:50%;margin-right:40px;.plus{display:inline-flex;text-align:center;-webkit-touch-callout:none;-webkit-user-select:none;-khtml-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;color:purple;font-size:25px;margin-bottom:2px;margin-right:2px;}"]);
var data = [{
...
//# sourceMappingURL=hipaa.js.0e618417b0558d40d4b2.hot-update.js.map