...
})(["border-radius:8px 8px 0 0;position:absolute;margin-left:20px;margin-top:10px;display:grid;width:245px;height:132px;grid-template-columns:1;grid-template-rows:35px 30px 1fr;box-shadow:0 0 5px 3px rgba(0,0,0,0.1);background:transparent;align-self:flex-start;.month{width:100%;display:grid;height:35px;background:rgba(20,110,220,1);grid-row:1;border-radius:8px 8px 0 0;align-content:center;align-items:center;justify-content:center;color:white;}"]);
...
//# sourceMappingURL=client.js.25c00b0b0ffb7a9ca205.hot-update.js.map