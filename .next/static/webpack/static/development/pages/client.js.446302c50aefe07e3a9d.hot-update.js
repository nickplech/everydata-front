...
function (_Component) {
  ...
  function ReviewMessage() {
    ...
    _defineProperty(_assertThisInitialized(_this), "saveToState", function (e) {
      ...
      var time = _this.state.time; //  const date = format(val, 'ddd, MMM Do')

      if (name === 'date') {
        _this.setState({
          date: Object(date_fns__WEBPACK_IMPORTED_MODULE_6__["format"])(val, 'ddd, MMM Do')
        });
      }

      var addVariables = _this.state.text.replace('<time>', time).replace('<date>', date);
  ...
  _createClass(ReviewMessage, [{
    ...
    value: function render() {
      ...
      // const finishedMessage = this.state.text
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_4__["Mutation"], {
        ...
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Form, {
          ...
          __self: this
        }, _this2.state.text.length, " of 160"), _this2.state.text.length < 160 && react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Send, {
          type: "submit",
          __source: {
            fileName: _jsxFileName,
            lineNumber: 249
...
//# sourceMappingURL=client.js.446302c50aefe07e3a9d.hot-update.js.map