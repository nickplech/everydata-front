...
})(["background-color:#fff;border-radius:25px;display:grid;grid-template-rows:50px 1fr 80px;grid-template-columns:1fr 1fr;position:absolute;align-items:center;width:500px;height:500px;padding:10px 25px;z-index:900;box-shadow:1px 1px 5px 3px rgba(0,0,0,0.3);.title{font-size:18px;justify-content:center;}"]);
...
//# sourceMappingURL=schedule.js.8be388d18eb96268639a.hot-update.js.map