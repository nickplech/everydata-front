...
})(["background:transparent;border-radius:50%;display:flex;align-items:center;justify-content:center;height:30px;width:30px;padding-bottom:6px;border:1px solid green;position:absolute;z-index:20;left:5px;top:5px;transform:rotateZ(46deg);cursor:pointer;opacity:0.6;outline:none;.child{position:absolute;justify-self:center;display:flex;color:green;font-size:3rem;padding-left:0px;}"]);
...
//# sourceMappingURL=account.js.06201b6acde7f1f6ac1b.hot-update.js.map