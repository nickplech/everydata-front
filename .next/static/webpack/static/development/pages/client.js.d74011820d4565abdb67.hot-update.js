...
})(["background:rgba(30,110,240,1);color:white;font-weight:800;border:none;width:75px;display:grid;grid-column:2;font-size:2rem;height:75px;font-size:1.8rem;border-radius:50%;outline:none;cursor:pointer;box-shadow:0 0 2px 3px rgba(0,0,0,0.05);&:active{box-shadow:none;}&[disabled]{opacity:0.5;}&:hover{background:rgba(30,110,240,0.9);}"]);
...
//# sourceMappingURL=client.js.d74011820d4565abdb67.hot-update.js.map