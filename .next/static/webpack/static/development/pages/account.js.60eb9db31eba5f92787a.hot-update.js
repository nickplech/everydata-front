...
})(["display:inline-block;padding-right:5;padding-left:5;transition:all 300ms cubic-bezier(0.4,0,0.2,1) 0ms;margin:16px 50px;cursor:pointer;opacity:0.4;&:hover{opacity:1;}"]); // props => {
//   return (
//     props.isActiveTab && {
...
})(["height:40px;background-color:#0088dd;position:absolute;bottom:0;transition:all 300ms cubic-bezier(0.4,0,0.2,1) 0ms;will-change:left,width;"]); // props => {
//   return (
...
//# sourceMappingURL=account.js.60eb9db31eba5f92787a.hot-update.js.map