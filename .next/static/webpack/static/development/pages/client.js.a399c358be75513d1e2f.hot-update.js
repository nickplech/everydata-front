...
})(["position:relative;display:grid;grid-row:1/3;grid-column:2;width:100%;height:100%;background-color:transparent;box-shadow:0 0 5px 3px rgba(0,0,0,0.05);border:5px solid white;border-radius:25px;z-index:-1;"]);
...
function (_Component) {
  ...
  _createClass(TextMessages, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(TextMessage, {
        __source: {
...
//# sourceMappingURL=client.js.a399c358be75513d1e2f.hot-update.js.map