...
})(["display:grid;grid-template-columns:1fr;grid-auto-rows:25px;grid-gap:1px;width:100%;border-left:3px solid blue;margin-top:20px;height:95%;overflow-y:scroll;overscroll-behavior:contain;.timeCell{display:flex;padding-left:5px;align-items:center;border-bottom:none;border-top:1px solid grey;color:grey;border:1px solid grey;}"]);
var DUMMY_DATA = [{
  time: 6,
  am: true
}, {
...
//# sourceMappingURL=schedule.js.b7e161336ea51f0db666.hot-update.js.map