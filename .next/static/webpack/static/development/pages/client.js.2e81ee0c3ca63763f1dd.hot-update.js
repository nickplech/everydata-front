...
function (_Component) {
  ...
  function ReviewMessage() {
    ...
    _defineProperty(_assertThisInitialized(_this), "saveToState", function (e) {
      ...
      var textTemplate = _this.props.seededMessage.replace('<date>', date);
    ...
    _defineProperty(_assertThisInitialized(_this), "saveTime", function (e) {
      ...
      var textTemplate = _this.props.seededMessage.replace('<time>', time, '<date>', date);
...
//# sourceMappingURL=client.js.2e81ee0c3ca63763f1dd.hot-update.js.map