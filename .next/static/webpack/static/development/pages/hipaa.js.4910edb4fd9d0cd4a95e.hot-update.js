...
})(["display:inline-flex;align-content:center;justify-content:center;width:30px;height:30px;background:white;.plus{display:inline-flex;align-self:center;justify-self:center;text-align:center;border:2px solid white;border-radius:50%;margin-right:40px;color:purple;font-size:25px;}"]);
var data = [{
...
//# sourceMappingURL=hipaa.js.4910edb4fd9d0cd4a95e.hot-update.js.map