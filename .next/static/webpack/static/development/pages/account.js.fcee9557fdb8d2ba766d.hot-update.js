...
})(["display:inline-flex;flex-flow:row;border-radius:35px;margin:0 10px;font-size:12px;padding:4px 10px;transition:0.3s;align-items:center;justify-content:center;cursor:pointer;&:focus{outline:none;transform:scale(1.2);}.picked{border:3px solid black;}"]);
...
//# sourceMappingURL=account.js.fcee9557fdb8d2ba766d.hot-update.js.map