...
})(["background-color:#fff;border-radius:25px;flex-flow:column;display:grid;grid-template-rows:50px 1fr 80px;position:absolute;align-items:center;width:500px;min-height:300px;padding:10px 25px;z-index:900;box-shadow:-1px -1px 10px 3px rgba(0,0,0,0.3);"]);
...
})(["background-color:#fff;border-radius:5px;display:grid;grid-row:3;position:relative;align-items:center;margin:0 auto;height:50%;background:rgba(220,100,120,1);color:white;width:120px;font-size:22px;z-index:900;&:focus{outline:none;}"]);
...
})(["background-color:#fff;border-radius:5px;display:grid;grid-row:3;margin:0 auto;position:relative;align-items:center;width:120px;height:50%;background:rgba(20,200,120,1);color:white;font-size:22px;z-index:900;&:focus{outline:none;}"]);
...
//# sourceMappingURL=signup.js.c58929d158db50ee34d3.hot-update.js.map