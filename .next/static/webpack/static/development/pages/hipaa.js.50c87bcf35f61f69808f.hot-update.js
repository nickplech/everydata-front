...
})(["display:inline-flex;align-content:center;justify-content:center;.plus{width:30px;height:30px;display:inline-flex;align-self:center;justify-self:center;text-align:center;border:2px solid white;border-radius:50%;margin-right:40px;background:white;color:purple;font-size:25px;}"]);
var data = [{
...
//# sourceMappingURL=hipaa.js.50c87bcf35f61f69808f.hot-update.js.map