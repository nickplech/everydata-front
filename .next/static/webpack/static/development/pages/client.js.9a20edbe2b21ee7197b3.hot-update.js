  ...
  function ReviewMessage() {
    ...
    _defineProperty(_assertThisInitialized(_this), "saveTimeMin", function (e) {
      var _e$target = e.target,
          ...
          name = _e$target.name; // const reg = new RegExp('^.* (?= (:))')

      var built = _this.state.time.replace('00', "".concat(value));
...
//# sourceMappingURL=client.js.9a20edbe2b21ee7197b3.hot-update.js.map