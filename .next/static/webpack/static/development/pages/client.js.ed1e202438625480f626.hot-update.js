  ...
  function ReviewMessage() {
    ...
    _defineProperty(_assertThisInitialized(_this), "saveTime", function (e) {
      ...
      if (name === 'date') {
        ...
        var _date = Object(date_fns__WEBPACK_IMPORTED_MODULE_6__["format"])(val, 'ddd, MMM Do');

        var textTemplate = _this.props.seededMessage.replace('<date>', _date, '<time>', time);
      ...
      if (name === 'time') {
        ...
        var _time = _this.state.time;

        var _textTemplate = _this.props.seededMessage.replace('<date>', date, '<time>', _time);
...
//# sourceMappingURL=client.js.ed1e202438625480f626.hot-update.js.map