...
function _templateObject2() {
  var data = _taggedTemplateLiteral(["\n  query TEXT_TEMPLATE_QUERY($name: String!) {\n    textTemplates(name: $name) {\n      id\n      name\n      content\n    }\n  }\n"]);
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_User__WEBPACK_IMPORTED_MODULE_10__["default"], {
        ...
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_4__["Query"], {
          ...
          var data = _ref2.data;
          var defaultTemplate = data.textTemplate[0].content.replace('<business>', business).replace('<phone>', phone).replace('<time>', time).replace('<date>', date);
...
//# sourceMappingURL=client.js.0b5a654a1778afdc2e14.hot-update.js.map