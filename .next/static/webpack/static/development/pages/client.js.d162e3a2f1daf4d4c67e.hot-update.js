...
})(["background:rgba(30,110,240,1);color:white;font-weight:800;border:none;width:75px;font-size:2rem;grid-column:2;grid-row:2;justify-self:flex-end;height:75px;font-size:1.8rem;border-radius:50%;outline:none;cursor:pointer;box-shadow:0 0 5px 3px rgba(0,0,0,0.1);&:active{box-shadow:none;transform:scale(1.05);}&[disabled]{opacity:0.5;}&:hover{background:rgba(30,110,240,0.9);transform:scale(1.1);}"]);
...
//# sourceMappingURL=client.js.d162e3a2f1daf4d4c67e.hot-update.js.map