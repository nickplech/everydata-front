...
})(["background-color:#fff;border-radius:25px;display:grid;grid-template-rows:80px 1fr 35px;grid-template-columns:1fr 1fr;position:absolute;align-items:flex-start;width:500px;height:500px;z-index:999;box-shadow:1px 1px 5px 3px rgba(0,0,0,0.3);"]);
...
})(["align-self:center;grid-column:1/3;grid-row:1;justify-content:center;background:rgba(20,110,220,1);overflow:hidden;p{margin:0;font-size:18px;position:relative;color:rgba(220,20,20,1);}.title{display:flex;font-size:18px;margin:0;color:rgba(20,110,220,1);position:relative;}h3{margin:0;}"]);
...
//# sourceMappingURL=schedule.js.1e61260af014a78e0dc5.hot-update.js.map