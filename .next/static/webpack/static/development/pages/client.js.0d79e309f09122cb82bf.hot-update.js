...
/* harmony import */ var _SingleClient__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./SingleClient */ "./components/SingleClient.js");
...
function (_Component) {
  ...
  _createClass(ReviewMessage, [{
    ...
    //   const data = cache.readQuery({ query: ALL_CLIENTS_REMINDERS })
    //   // 2. remove that item from the cart
    //   console.log(data)
    //   const textReminderId = payload.data.createTextReminder.id
    //   data.textReminders = data.textReminders.map(textReminder => textReminder.id !== textReminderId)
    //   // 3. write it back to the cache
    //   cache.writeQuery({ query: ALL_CLIENTS_REMINDERS, data })
    // }
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_User__WEBPACK_IMPORTED_MODULE_9__["default"], {
        ...
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_4__["Query"], {
          ...
          return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_4__["Mutation"], {
            mutation: SEND_TEXT_MUTATION // update={this.update}
            ,
            variables: {
              to: to,
              text: text,
            ...
            refetchQueries: [{
              query: _SingleClient__WEBPACK_IMPORTED_MODULE_8__["ALL_CLIENTS_REMINDERS"]
            }],
            __source: {
              fileName: _jsxFileName,
              lineNumber: 196
...
//# sourceMappingURL=client.js.0d79e309f09122cb82bf.hot-update.js.map