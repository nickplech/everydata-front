...
})(["background-color:#fff;border-radius:25px;flex-flow:column;display:grid;grid-template-rows:50px 1fr 80px;position:absolute;align-items:center;width:500px;min-height:300px;padding:25px 25px;z-index:900;"]);
...
})(["background-color:#fff;border-radius:5px;display:grid;grid-row:3;position:relative;align-items:center;padding:0 15px;height:70%;background:rgba(20,100,220,1);color:white;width:120px;margin:0 15px;font-size:22px;z-index:900;"]);
...
})(["background-color:#fff;border-radius:5px;display:grid;grid-row:3;margin:0 15px;position:relative;align-items:center;padding:0 15px;width:120px;height:70%;background:rgba(20,100,220,1);color:white;font-size:22px;z-index:900;"]);
...
//# sourceMappingURL=schedule.js.0718d51092febc91a388.hot-update.js.map