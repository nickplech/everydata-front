...
})(["position:relative;display:grid;box-sizing:border-box;padding-left:6px;width:100%;height:100%;overflow-y:scroll;background:white;.message{align-content:center;justify-content:center;margin:0px 30px;padding:0px;border-bottom:1.5px solid rgba(220,220,220,0.4);}.message-username{font-size:11px;color:#3e5869;opacity:0.9;}.message-text{background:rgba(220,220,220,0.8);font-family:'Montserrat',sans-serif;color:black;display:block;font-size:12px;padding:12px 14px;margin:0px 0;border-radius:8px;width:50%;height:80%;max-width:600px;min-width:300px;}"]);
var DUMMY_DATA = [{
  senderId: 'perborgen',
...
//# sourceMappingURL=client.js.d88a850a2007bf4b7612.hot-update.js.map