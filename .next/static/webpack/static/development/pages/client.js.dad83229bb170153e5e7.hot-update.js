...
function (_Component) {
  ...
  function SingleClient() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(SingleClient)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_this), "messagesEnd", react__WEBPACK_IMPORTED_MODULE_0___default.a.createRef());

    _defineProperty(_assertThisInitialized(_this), "scrollToBottom", function () {
      _this.messagesEnd.current.scrollIntoView({
        behavior: 'smooth'
      });
    });
...
//# sourceMappingURL=client.js.dad83229bb170153e5e7.hot-update.js.map