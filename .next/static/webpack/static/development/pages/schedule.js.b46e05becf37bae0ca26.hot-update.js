...
})(["display:grid;position:relative;grid-template-columns:60px 1fr;position:absolute;grid-auto-rows:25px;border-radius:0px 0 25px 0;grid-gap:1px;width:100%;right:0px;margin-top:67px;height:75vh;overflow-y:scroll;overscroll-behavior:contain;"]);
...
})(["display:grid;grid-column:1;text-align:left;font-weight:800;color:white;background:transparent;border:none;opacity:1;cursor:pointer;color:rgba(20,110,240,0.65);&:focus{outline:none;}"]);
...
})(["display:grid;border-left:none;grid-column:2/3;padding-left:5px;align-items:center;border-bottom:none;border:2px solid rgba(203,201,204,1);cursor:pointer;&:nth-child(4n + 2){display:grid;grid-column:1/3;align-items:center;border:2px solid rgba(20,110,240,0.65);border-radius:20px 0 0 20px;background:rgba(20,110,240,0.45);color:grey;border-right:none;}&:hover{opacity:0.5;}.number{display:grid;font-size:12px;align-self:center;justify-content:flex-start;-webkit-touch-callout:none;-webkit-user-select:none;-khtml-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;}"]);
...
//# sourceMappingURL=schedule.js.b46e05becf37bae0ca26.hot-update.js.map