...
})(["border:none;border-radius:50%;align-items:center;outline:none;text-align:center;color:white;display:flex;flex-flow:row wrap;cursor:pointer;position:relative;width:35px;height:35px;&:hover{transform:scale(1.1);}&:disabled{opacity:0.4;}"]);
var hourOptions = [{
  value: '1:00',
  label: '1'
}, {
...
//# sourceMappingURL=client.js.119ba4328e524edd4691.hot-update.js.map