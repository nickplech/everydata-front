...
})(["display:inline-block;background:rgba(100,100,220,1);border:3px solid rgba(100,100,220,1);margin-left:25px;padding:8px 12px;width:200px;margin-top:15px;color:white;border-radius:5px;font-size:18px;cursor:pointer;&:hover{border-color:yellow;color:yellow;}"]);
...
//# sourceMappingURL=index.js.f341955987accbb63ee6.hot-update.js.map