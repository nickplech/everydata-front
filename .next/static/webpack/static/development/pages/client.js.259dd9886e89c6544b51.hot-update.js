...
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n  mutation SEND_TEXT_MUTATION(\n    $to: String!\n    $from: String!\n    $text: String!\n    $client: ID!\n    $time: String!\n    $date: DateTime\n  ) {\n    createTextReminder(to: $to, from: $from, text: $text, client: $client, time: $time, $date: $DateTime) {\n      id\n      text\n      client {\n        id\n      }\n      confirmationStatus\n    }\n  }\n"]);
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Back, {
          ...
          return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_3__["Query"], {
            ...
            return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_DaySelector__WEBPACK_IMPORTED_MODULE_4__["default"], {
              ...
              readOnly: true,
              max: 160,
              defaultValue: data.textTemplates[0].content.replace('<business>', business).replace('<phone>', phone).replace('<time>', time).replace('<date>', Object(date_fns__WEBPACK_IMPORTED_MODULE_5__["format"])(date, 'MMM Do')),
              __source: {
                fileName: _jsxFileName,
                lineNumber: 137
              },
...
//# sourceMappingURL=client.js.259dd9886e89c6544b51.hot-update.js.map